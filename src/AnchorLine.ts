 ...
 * @LastEditors: wjz
 * @LastEditTime: 2022-03-09 09:27:14
...
export default class AnchorLine extends Konva.Group {
   ...
   * @returns 克隆后的节点
   */
  clone(obj: any ={}) {   //未完全克隆对象
    // 克隆后的节点始终为最上层节点，不是克隆目标本身   bug原因

    // let originProto = Object.getPrototypeOf(this);
    // let self = Object.assign(Object.create(originProto), this);
    // // console.log(self.position());

    // let _drag_anchor = self.find("._drag_anchor")
    // console.log(_drag_anchor);
