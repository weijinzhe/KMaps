(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.KMap = factory());
	...
	***************************************************************************** */
	...
	class Track extends konva_min.Group {
	    constructor(attrs = { pixelRatio: 2, strokeWidth: 5 }) {
	        attrs["id"] = "Track";
	        attrs["pixelRatio"] = 2;
	        attrs["strokeWidth"] = 5;
	        super(attrs);
	...
	class Line extends ShapeNode {
	    constructor(attrs) {
	        super(Object.assign(Object.assign({}, attrs), { name: "Line", strokeWidth: attrs.strokeWidth || 4, hitStrokeWidth: 20 }));
	        let self = this;
	        this._stage = window["_KMap"]["_Stage"]; //(window as any)._KMap_Stage
	        this._stage.addEventListener("pinchend", function (e) {
	            e.cancelBubble = true;
	...
	class Polygon extends ShapeNode {
	    constructor(attrs) {
	        super(Object.assign(Object.assign({}, attrs), { name: "Polygon", strokeWidth: attrs.strokeWidth || 1, hitStrokeWidth: 0 }));
	        let self = this;
	        this._stage = window["_KMap"]["_Stage"]; //(window as any)._KMap_Stage
	        this._stage.addEventListener("pinchend", function (e) {
	            e.cancelBubble = true;
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-20 00:20:10
