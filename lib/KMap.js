(function (global, factory) {
	...
	class Stage extends konva_min.Stage {
	    constructor(attrs) {
	        ...
	        super(attrs);
	        window._KMap_Stage = this; //将_KMap挂载到window对象上
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-16 10:44:25
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-16 10:56:17
	...
	class Grid extends konva_min.Group {
	    ...
	    drawGraph() {
	        ...
	        let sizeW = stageNode.width(), sizeH = stageNode.height();
	        let self = this;
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-16 11:31:43
	 * @FilePath: /kmaps/src/Location.ts
	 */
	const _getDraggable = Symbol('_getDraggable');
	/**
	 * @description 定位点，图形组
	 * @class
	 * @constructor
	...
	class Location extends konva_min.Group {
	    constructor(attrs = {}) {
	        ...
	        this._stage = window._KMap_Stage;
	    ...
	    drawGraph() {
	        ...
	        _drag_group_anchor.addEventListener('dragmove', function (e) {
	            let { x, y } = this.position(); //this.absolutePosition()
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-16 11:05:38
