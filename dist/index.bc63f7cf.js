(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.KMaps = factory());
})(this, function() {
    'use strict';
    ...
    var konva_min = createCommonjsModule(function(module, exports) {
        !function(t, e) {
            ...
            var t1 = Math.PI / 180;
            const e1 = "undefined" != typeof commonjsGlobal ? commonjsGlobal : "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope ? self : {
            }, i1 = {
                _global: e1,
                version: "8.3.3",
                isBrowser: "undefined" != typeof window && ("[object Window]" === ({
                }).toString.call(window) || "[object global]" === ({
                }).toString.call(window)),
                isUnminified: /param/.test((function(t) {
                }).toString()),
                dblClickWindow: 400,
                getAngle: (e)=>i1.angleDeg ? e * t1 : e
                ,
                enableTrace: !1,
                ...
                isDragging: ()=>i1.DD.isDragging
                ,
                isDragReady: ()=>!!i1.DD.node
                ,
            ...
            class a1 {
                ...
                rotate(t) {
                    var e = Math.cos(t), i = Math.sin(t), r = this.m[0] * e + this.m[2] * i, a = this.m[1] * e + this.m[3] * i, n = this.m[0] * -i + this.m[2] * e, s = this.m[1] * -i + this.m[3] * e;
                ...
                skew(t, e) {
                    var i = this.m[0] + this.m[2] * e, r = this.m[1] + this.m[3] * e, a = this.m[2] + this.m[0] * t, n = this.m[3] + this.m[1] * t;
                    return this.m[0] = i, this.m[1] = r, this.m[2] = a, this.m[3] = n, this;
                }
                multiply(t) {
                    var e = this.m[0] * t.m[0] + this.m[2] * t.m[1], i = this.m[1] * t.m[0] + this.m[3] * t.m[1], r = this.m[0] * t.m[2] + this.m[2] * t.m[3], a = this.m[1] * t.m[2] + this.m[3] * t.m[3], n = this.m[0] * t.m[4] + this.m[2] * t.m[5] + this.m[4], s = this.m[1] * t.m[4] + this.m[3] * t.m[5] + this.m[5];
                    return this.m[0] = e, this.m[1] = i, this.m[2] = r, this.m[3] = a, this.m[4] = n, this.m[5] = s, this;
                }
                invert() {
                    var t = 1 / (this.m[0] * this.m[3] - this.m[1] * this.m[2]), e = this.m[3] * t, i = -this.m[1] * t, r = -this.m[2] * t, a = this.m[0] * t, n = t * (this.m[2] * this.m[5] - this.m[3] * this.m[4]), s = t * (this.m[1] * this.m[4] - this.m[0] * this.m[5]);
                    return this.m[0] = e, this.m[1] = i, this.m[2] = r, this.m[3] = a, this.m[4] = n, this.m[5] = s, this;
                }
                getMatrix() {
                    return this.m;
                ...
                setAbsolutePosition(t, e) {
                    var i = this.m[0], r = this.m[1], a = this.m[2], n = this.m[3], s = this.m[4], o = (i * (e - this.m[5]) - r * (t - s)) / (i * n - r * a), h = (t - s - a * o) / i;
                    return this.translate(h, o);
                }
                decompose() {
                    var t = this.m[0], e = this.m[1], i = this.m[2], r = this.m[3], a = t * r - e * i;
                    let n = {
                        x: this.m[4],
                        y: this.m[5],
                        rotation: 0,
            ...
            var n1 = Math.PI / 180, s = 180 / Math.PI, o = "Konva error: ", h = {
                aliceblue: [
                    240,
                    248,
                    255
            ...
            const c = "undefined" != typeof requestAnimationFrame && requestAnimationFrame || function(t) {
                ...
                _rgbToHex: (t, e, i)=>(16777216 + (t << 16) + (e << 8) + i).toString(16).slice(1)
                ,
                _hexToRgb (t) {
                    t = t.replace("#", "");
                    var e = parseInt(t, 16);
                ...
                colorToRGBA: (t)=>(t = t || "black", g._namedColorToRBA(t) || g._hex3ColorToRGBA(t) || g._hex6ColorToRGBA(t) || g._rgbColorToRGBA(t) || g._rgbaColorToRGBA(t) || g._hslColorToRGBA(t))
                ,
                _namedColorToRBA (t) {
                ...
                _hslColorToRGBA (t) {
                    if (/hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.test(t)) {
                        ...
                        for(let t2 = 0; t2 < 3; t2++)o = r + 1 / 3 * -(t2 - 1), o < 0 && o++, o > 1 && o--, h = 6 * o < 1 ? l + 6 * (s - l) * o : 2 * o < 1 ? s : 3 * o < 2 ? l + (s - l) * (2 / 3 - o) * 6 : l, d[t2] = 255 * h;
                        return {
                            r: Math.round(d[0]),
                            g: Math.round(d[1]),
                            b: Math.round(d[2]),
                ...
                ,
                _getRotation: (t)=>i1.angleDeg ? g.radToDeg(t) : t
                ,
                ...
                warn (t) {
                    i1.showWarnings && console.warn("Konva warning: " + t);
                },
                each (t, e) {
                ...
                _getProjectionToLine (t, e, i) {
                    var r = g.cloneObject(t), a = Number.MAX_VALUE;
            ...
            function p() {
                if (i1.isUnminified) return function(t, e) {
                    return g._isNumber(t) || g.warn(u(t) + ' is a not valid value for "' + e + '" attribute. The value should be a number.'), t;
                };
            }
            function v(t) {
                if (i1.isUnminified) return function(e, i) {
                    let r = g._isNumber(e), a = g._isArray(e) && e.length == t;
            ...
            function y() {
                if (i1.isUnminified) return function(t, e) {
                    const i = g._isString(t), r = "[object CanvasGradient]" === Object.prototype.toString.call(t) || t && t.addColorStop;
            ...
            const w = {
                ...
                addComponentsGetterSetter (t, e, r, a, n) {
                    var s, o, h = r.length, l = g._capitalize, d = b + l(e), c = S + l(e);
                    ...
                    var f = function(t) {
                        if (i1.isUnminified) return function(e, i) {
                            return g.isObject(e) || g.warn(u(e) + ' is a not valid value for "' + i + '" attribute. The value should be an object with properties ' + t), e;
                        };
                    }(r);
                ...
                addOverloadedGetterSetter (t, e) {
                    var i = g._capitalize(e), r = S + i, a = b + i;
                ...
                addDeprecatedGetterSetter (t, e, i, r) {
                    ...
                    var a = b + g._capitalize(e), n = e + " property is deprecated and will be removed soon. Look at Konva change log for more information.";
                ...
                backCompat (t, e) {
                    g.each(e, function(e, i) {
                        var r = t.prototype[i], a = b + g._capitalize(e), n = S + g._capitalize(e);
                        function s() {
            ...
            function C(t) {
                var e, i, r = [], a = t.length, n = g;
                for(e = 0; e < a; e++)i = t[e], n._isNumber(i) ? i = Math.round(1000 * i) / 1000 : n._isString(i) || (i += ""), r.push(i);
                return r;
            }
            var P = [
                "arc",
            ...
            class k {
                constructor(t){
                    this.canvas = t, this._context = t._canvas.getContext("2d"), i1.enableTrace && (this.traceArr = [], this._enableTrace());
                }
                fillShape(t) {
                ...
                getTrace(t, e) {
                    ...
                    for(i = 0; i < o; i++)(a = (r = s[i]).method) ? (n = r.args, h += a, t ? h += "()" : g._isArray(n[0]) ? h += "([" + n.join(",") + "])" : (e && (n = n.map((t)=>"number" == typeof t ? Math.floor(t) : t
                ...
                _enableTrace() {
                    var t, e, i = this, r = P.length, a = this.setAttr, n = function(t) {
                        var r, a = i[t];
                        i[t] = function() {
                            return e = C(Array.prototype.slice.call(arguments, 0)), r = a.apply(i, arguments), i._trace({
                                method: t,
                                args: e
                            }), r;
                        };
            ...
            class G {
                constructor(t){
                    ...
                    var e = (t || {
                    }).pixelRatio || i1.pixelRatio || function() {
                        if (M) return M;
                        var t = g.createCanvasElement().getContext("2d");
                        return M = (i1._global.devicePixelRatio || 1) / (t.webkitBackingStorePixelRatio || t.mozBackingStorePixelRatio || t.msBackingStorePixelRatio || t.oBackingStorePixelRatio || t.backingStorePixelRatio || 1);
                    }();
            ...
            const L = {
                get isDragging () {
                    var t = !1;
                    return L._dragElements.forEach((e)=>{
                ...
                _endDragBefore (t) {
                    L._dragElements.forEach((e)=>{
                        ...
                        if (!a._changedPointerPositions.find((t)=>t.id === e.pointerId
                        )) return;
                        "dragging" !== e.dragStatus && "stopped" !== e.dragStatus || (L.justDragged = !0, i1._mouseListenClick = !1, i1._touchListenClick = !1, i1._pointerListenClick = !1, e.dragStatus = "stopped");
                        const n = e.node.getLayer() || e.node instanceof i1.Stage && e.node;
                        n && n.batchDraw();
                    });
                },
                _endDragAfter (t) {
                    L._dragElements.forEach((e, i)=>{
                        "stopped" === e.dragStatus && e.node.fire("dragend", {
                            ...
                            target: e.node,
                            evt: t
                        }, !0), "dragging" !== e.dragStatus && L._dragElements.delete(i);
                    });
                }
            };
            i1.isBrowser && (window.addEventListener("mouseup", L._endDragBefore, !0), window.addEventListener("touchend", L._endDragBefore, !0), window.addEventListener("mousemove", L._drag), window.addEventListener("touchmove", L._drag), window.addEventListener("mouseup", L._endDragAfter, !1), window.addEventListener("touchend", L._endDragAfter, !1));
            var D = "absoluteOpacity", O = "allEventListeners", I = "absoluteTransform", F = "absoluteScale", N = "canvas", B = "listening", z = "mouseenter", W = "mouseleave", H = "Shape", Y = " ", X = "stage", j = "transform", U = "visible", q = [
                "xChange.konva",
                "yChange.konva",
                "scaleXChange.konva",
                "scaleYChange.konva",
            ...
            class K {
                constructor(t){
                    this._id = V++, this.eventListeners = {
                    }, this.attrs = {
                ...
                _calculate(t, e, i) {
                    if (!this._attachedDepsListeners.get(t)) {
                        const i = e.map((t)=>t + "Change.konva"
                        ).join(Y);
                        this.on(i, ()=>{
                            this._clearCache(t);
                ...
                cache(t) {
                    ...
                    if (r && a) {
                        ...
                        var c = new E({
                            ...
                            width: r,
                            height: a
                        }), p = c.getContext(), v = f.getContext();
                        return f.isCache = !0, c.isCache = !0, this._cache.delete(N), this._filterUpToDate = !1, !1 === e.imageSmoothingEnabled && (c.getContext()._context.imageSmoothingEnabled = !1, u.getContext()._context.imageSmoothingEnabled = !1), p.save(), v.save(), p.translate(-s, -o), v.translate(-s, -o), this._isUnderCache = !0, this._clearSelfAndDescendantCache(D), this._clearSelfAndDescendantCache(F), this.drawScene(c, this), this.drawHit(f, this), this._isUnderCache = !1, p.restore(), v.restore(), l && (p.save(), p.beginPath(), p.rect(0, 0, r, a), p.closePath(), p.setAttr("strokeStyle", "red"), p.setAttr("lineWidth", 5), p.stroke(), p.restore()), this._cache.set(N, {
                            scene: c,
                            filter: u,
                            hit: f,
                            x: s,
                ...
                _getCachedSceneCanvas() {
                    var t, e, i, r, a = this.filters(), n = this._getCanvasCache(), s = n.scene, o = n.filter, h = o.getContext();
                    if (a) {
                        if (!this._filterUpToDate) {
                            ...
                            try {
                                ...
                                g.error("Unable to apply filter. " + t2.message + " This post my help you https://konvajs.org/docs/posts/Tainted_Canvas.html.");
                            }
                ...
                off(t, e) {
                    ...
                    if (this._cache && this._cache.delete(O), !t) for(r in this.eventListeners)this._off(r);
                ...
                getAbsoluteZIndex() {
                    ...
                    return "Stage" !== n.nodeType && (function o(h) {
                        for(t = [], e = h.length, i = 0; i < e; i++)r = h[i], s++, r.nodeType !== H && (t = t.concat(r.getChildren().slice())), r._id === n._id && (i = e);
                ...
                _batchTransformChanges(t) {
                    this._batchingTransformChange = !0, t(), this._batchingTransformChange = !1, this._needClearTransformCache && (this._clearCache(j), this._clearSelfAndDescendantCache(I)), this._needClearTransformCache = !1;
                }
                setPosition(t) {
                    return this._batchTransformChanges(()=>{
                ...
                getAbsolutePosition(t) {
                    ...
                    e && !t && (t = !0);
                    var r = this.getAbsoluteTransform(t).getMatrix(), n = new a1, s = this.offset();
                ...
                setAbsolutePosition(t) {
                    ...
                    return i.invert(), i.translate(t.x, t.y), t = {
                        ...
                        x: t.x,
                        y: t.y
                    }), this._clearCache(j), this._clearSelfAndDescendantCache(I), this;
                }
                _setTransform(t) {
                    var e;
                ...
                toObject() {
                    ...
                    for(t in a.attrs = {
                    }, n)e = n[t], g.isObject(e) && !g._isPlainObject(e) && !g._isArray(e) || (i = "function" == typeof this[t] && this[t], delete n[t], r = i ? i.call(this) : null, n[t] = e, r !== e && (a.attrs[t] = e));
                ...
                _isMatch(t) {
                    ...
                    for(e = 0; e < a; e++)if (i = r[e], g.isValidSelector(i) || (g.warn('Selector "' + i + '" is invalid. Allowed selectors examples are "#foo", ".bar" or "Group".'), g.warn('If you have a custom shape with such className, please change it to start with upper letter like "Triangle".'), g.warn("Konva is awesome, right?")), "#" === i.charAt(0)) {
                ...
                _getAbsoluteTransform(t) {
                    var e;
                    if (t) return e = new a1, this._eachAncestorReverse(function(t) {
                        var i = t.transformsEnabled();
                        "all" === i ? e.multiply(t.getTransform()) : "position" === i && e.translate(t.x() - t.offsetX(), t.y() - t.offsetY());
                    }, t), e;
                    e = this._cache.get(I) || new a1, this.parent ? this.parent.getAbsoluteTransform().copyInto(e) : e.reset();
                ...
                _getTransform() {
                    var t, e, r = this._cache.get(j) || new a1;
                    r.reset();
                    var n = this.x(), s = this.y(), o = i1.getAngle(this.rotation()), h = null !== (t = this.attrs.scaleX) && void 0 !== t ? t : 1, l = null !== (e = this.attrs.scaleY) && void 0 !== e ? e : 1, d = this.attrs.skewX || 0, c = this.attrs.skewY || 0, g = this.attrs.offsetX || 0, u = this.attrs.offsetY || 0;
                ...
                _toKonvaCanvas(t) {
                    ...
                    var e = this.getClientRect(), i = this.getStage(), r = void 0 !== t.x ? t.x : e.x, a = void 0 !== t.y ? t.y : e.y, n = t.pixelRatio || 1, s = new E({
                ...
                toDataURL(t) {
                    var e = (t = t || {
                    }).mimeType || null, i = t.quality || null, r = this._toKonvaCanvas(t).toDataURL(e, i);
                    return t.callback && t.callback(r), r;
                }
                toImage(t) {
                    if (!t || !t.callback) throw "callback required for toImage method config argument";
                    var e = t.callback;
                    delete t.callback, g._urlToImage(this.toDataURL(t), function(t) {
                        e(t);
                    });
                }
                setSize(t) {
                ...
                getDragDistance() {
                    return void 0 !== this.attrs.dragDistance ? this.attrs.dragDistance : this.parent ? this.parent.getDragDistance() : i1.dragDistance;
                }
                _off(t, e, i) {
                ...
                _fireAndBubble(t, e, i) {
                    if (e && this.nodeType === H && (e.target = this), !((t === z || t === W) && (i && (this === i || this.isAncestorOf && this.isAncestorOf(i)) || "Stage" === this.nodeType && !i))) {
                        this._fire(t, e);
                ...
                _getProtoListeners(t) {
                    ...
                    if (!e) {
                        ...
                        for(; t;)if (t.eventListeners) {
                            for(var i in t.eventListeners){
                                const r = t.eventListeners[i], a = e[i] || [];
                                e[i] = r.concat(a);
                            }
                ...
                startDrag(t, e = !0) {
                    ...
                    L._dragElements.get(this._id).dragStatus = "dragging", this.fire("dragstart", {
                        type: "dragstart",
                        target: this,
                        evt: t && t.evt
                    }, e);
                ...
                _listenDrag() {
                    this._dragCleanup(), this.on("mousedown.konva touchstart.konva", function(t) {
                        if ((!(void 0 !== t.evt.button) || i1.dragButtons.indexOf(t.evt.button) >= 0) && !this.isDragging()) {
                            var e = !1;
                            L._dragElements.forEach((t)=>{
                ...
                _dragChange() {
                    if (this.attrs.draggable) this._listenDrag();
                        ...
                        const t = L._dragElements.get(this._id), e = t && "dragging" === t.dragStatus, i = t && "ready" === t.dragStatus;
                ...
                static _createNode(t, e) {
                    var r, a, n, s = K.prototype.getClassName.call(t), o = t.children;
                    e && (t.attrs.container = e), i1[s] || (g.warn('Can not find a node with class name "' + s + '". Fallback to "Shape".'), s = "Shape");
                    if (r = new i1[s](t.attrs), o) for(a = o.length, n = 0; n < a; n++)r.add(K._createNode(o[n]));
                    return r;
                }
            }
            K.prototype.nodeType = "Node", K.prototype._attrsAffectingSize = [], K.prototype.eventListeners = {
            ...
            Q(K, "zIndex"), Q(K, "absolutePosition"), Q(K, "position"), Q(K, "x", 0, p()), Q(K, "y", 0, p()), Q(K, "globalCompositeOperation", "source-over", _()), Q(K, "opacity", 1, p()), Q(K, "name", "", _()), Q(K, "id", "", _()), Q(K, "rotation", 0, p()), w.addComponentsGetterSetter(K, "scale", [
                "x",
                "y"
            ]), Q(K, "scaleX", 1, p()), Q(K, "scaleY", 1, p()), w.addComponentsGetterSetter(K, "skew", [
                "x",
                "y"
            ]), Q(K, "skewX", 0, p()), Q(K, "skewY", 0, p()), w.addComponentsGetterSetter(K, "offset", [
                "x",
                "y"
            ]), Q(K, "offsetX", 0, p()), Q(K, "offsetY", 0, p()), Q(K, "dragDistance", null, p()), Q(K, "width", 0, p()), Q(K, "height", 0, p()), Q(K, "listening", !0, x()), Q(K, "preventDefault", !0, x()), Q(K, "filters", null, function(t) {
                return this._filterUpToDate = !1, t;
            }), Q(K, "visible", !0, x()), Q(K, "transformsEnabled", "all", _()), Q(K, "size"), Q(K, "dragBoundFunc"), Q(K, "draggable", !1, x()), w.backCompat(K, {
                rotateDeg: "rotate",
            ...
            class J extends K {
                ...
                _drawChildren(t, e, i) {
                    ...
                    f && (a.save(), a._applyGlobalCompositeOperation(this)), null === (r = this.children) || void 0 === r || r.forEach(function(r) {
                        r[t](e, i);
                    }), f && a.restore(), h && a.restore();
                }
                getClientRect(t) {
                    var e, i, r, a, n, s = (t = t || {
                    }).skipTransform, o = t.relativeTo, h = {
                        x: 1 / 0,
                        y: 1 / 0,
                        width: 0,
                        height: 0
            ...
            w.addComponentsGetterSetter(J, "clip", [
                "x",
                "y",
                "width",
                "height"
            ]), w.addGetterSetter(J, "clipX", void 0, p()), w.addGetterSetter(J, "clipY", void 0, p()), w.addGetterSetter(J, "clipWidth", void 0, p()), w.addGetterSetter(J, "clipHeight", void 0, p()), w.addGetterSetter(J, "clipFunc");
            const Z = new Map, $ = void 0 !== i1._global.PointerEvent;
            function tt(t) {
                return Z.get(t);
            }
            function et(t) {
            ...
            var nt = "mouseleave", st = "mouseover", ot = "mouseenter", ht = "mousemove", lt = "mousedown", dt = "mouseup", ct = "pointermove", gt = "pointerdown", ut = "pointerup", ft = "pointercancel", pt = "pointerout", vt = "pointerleave", mt = "pointerover", _t = "pointerenter", yt = "contextmenu", xt = "touchstart", bt = "touchend", St = "touchmove", wt = "touchcancel", Ct = "wheel", Pt = [
                [
                    ot,
                    "_pointerenter"
                ],
            ...
            , At = (t)=>{
                const e = Tt(t);
                return "pointer" === e ? i1.pointerEventsEnabled && kt.pointer : "touch" === e ? kt.touch : "mouse" === e ? kt.mouse : void 0;
            };
            function Mt(t = {
            }) {
            ...
            class Et extends J {
                constructor(t){
                    super(Mt(t)), this._pointerPositions = [], this._changedPointerPositions = [], this._buildDOM(), this._bindContentEvents(), Gt.push(this), this.on("widthChange.konva heightChange.konva", this._resizeDOM), this.on("visibleChange.konva", this._checkVisibility), this.on("clipWidthChange.konva clipHeightChange.konva clipFuncChange.konva", ()=>{
                        Mt(this.attrs);
                ...
                clone(t) {
                    return t || (t = {
                    }), t.container = "undefined" != typeof document && document.createElement("div"), J.prototype.clone.call(this, t);
                }
                destroy() {
                    super.destroy();
                    var t = this.content;
                ...
                _toKonvaCanvas(t) {
                    (t = t || {
                    }).x = t.x || 0, t.y = t.y || 0, t.width = t.width || this.width(), t.height = t.height || this.height();
                    var e = new E({
                        width: t.width,
                        height: t.height,
                ...
                add(t, ...e) {
                    ...
                    return a > 5 && g.warn("The stage has " + a + " layers. Recommended maximum number of layers is 3-5. Adding more layers into the stage may drop the performance. Rethink your tree structure, you can use Konva.Group."), t.setSize({
                        width: this.width(),
                        height: this.height()
                    }), t.draw(), i1.isBrowser && this.content.appendChild(t.canvas._canvas), this;
                }
                getParent() {
                    return null;
                }
                ...
                _pointerleave(t) {
                    const e = At(t.type), r = Tt(t.type);
                    if (e) {
                        this.setPointersPositions(t);
                        var a = this._getTargetShape(r), n = !L.isDragging || i1.hitOnDragEnabled;
                ...
                _pointerdown(t) {
                    ...
                    if (e) {
                        ...
                        this._changedPointerPositions.forEach((n)=>{
                            ...
                            L.justDragged = !1, i1["_" + r + "ListenClick"] = !0;
                            if (!(s && s.isListening())) return;
                            i1.capturePointerEventsEnabled && s.setPointerCapture(n.id), this[r + "ClickStartShape"] = s, s._fireAndBubble(e.pointerdown, {
                                evt: t,
                                pointerId: n.id
                            }), a = !0;
                ...
                _pointermove(t) {
                    const e = At(t.type), r = Tt(t.type);
                    if (!e) return;
                    if (L.isDragging && L.node.preventDefault() && t.cancelable && t.preventDefault(), this.setPointersPositions(t), !(!L.isDragging || i1.hitOnDragEnabled)) return;
                    var a = {
                    };
                    let n = !1;
                    var s = this._getTargetShape(r);
                    this._changedPointerPositions.forEach((i)=>{
                        const o = tt(i.id) || this.getIntersection(i), h = i.id, l = {
                            evt: t,
                            pointerId: h
                        };
                        var d = s !== o;
                        if (d && s && (s._fireAndBubble(e.pointerout, Object.assign({
                        }, l), o), s._fireAndBubble(e.pointerleave, Object.assign({
                        }, l), o)), o) {
                            if (a[o._id]) return;
                            a[o._id] = !0;
                        }
                        o && o.isListening() ? (n = !0, d && (o._fireAndBubble(e.pointerover, Object.assign({
                        }, l), s), o._fireAndBubble(e.pointerenter, Object.assign({
                        }, l), s), this[r + "targetShape"] = o), o._fireAndBubble(e.pointermove, Object.assign({
                        }, l))) : s && (this._fire(e.pointerover, {
                            evt: t,
                            target: this,
                            currentTarget: this,
                            pointerId: h
                ...
                _pointerup(t) {
                    ...
                    if (!e) return;
                    this.setPointersPositions(t);
                    const a = this[r + "ClickStartShape"], n = this[r + "ClickEndShape"];
                    var s = {
                    };
                    let o = !1;
                    this._changedPointerPositions.forEach((h)=>{
                        ...
                        let g = !1;
                        i1["_" + r + "InDblClickWindow"] ? (g = !0, clearTimeout(this[r + "DblTimeout"])) : L.justDragged || (i1["_" + r + "InDblClickWindow"] = !0, clearTimeout(this[r + "DblTimeout"])), this[r + "DblTimeout"] = setTimeout(function() {
                            i1["_" + r + "InDblClickWindow"] = !1;
                        }, i1.dblClickWindow), l && l.isListening() ? (o = !0, this[r + "ClickEndShape"] = l, l._fireAndBubble(e.pointerup, Object.assign({
                        }, c)), i1["_" + r + "ListenClick"] && a && a === l && (l._fireAndBubble(e.pointerclick, Object.assign({
                        }, c)), g && n && n === l && l._fireAndBubble(e.pointerdblclick, Object.assign({
                        }, c)))) : (this[r + "ClickEndShape"] = null, i1["_" + r + "ListenClick"] && this._fire(e.pointerclick, {
                            evt: t,
                            target: this,
                            currentTarget: this,
                            pointerId: d
                        ...
                        currentTarget: this,
                        pointerId: this._changedPointerPositions[0].id
                    }), i1["_" + r + "ListenClick"] = !1, t.cancelable && t.preventDefault();
                }
                _contextmenu(t) {
                    this.setPointersPositions(t);
            ...
            Et.prototype.nodeType = "Stage", r1(Et), w.addGetterSetter(Et, "container");
            ...
            class zt extends K {
                ...
                __getFillPattern() {
                    if (this.fillPatternImage()) {
                        ...
                        if (t && t.setTransform) {
                            const e = new a1;
                            e.translate(this.fillPatternX(), this.fillPatternY()), e.rotate(i1.getAngle(this.fillPatternRotation())), e.scale(this.fillPatternScaleX(), this.fillPatternScaleY()), e.translate(-1 * this.fillPatternOffsetX(), -1 * this.fillPatternOffsetY());
                            const r = e.getMatrix();
                            t.setTransform({
                                a: r[0],
                                b: r[1],
                ...
                __getLinearGradient() {
                    ...
                    if (t) {
                        for(var e = Nt(), i = this.fillLinearGradientStartPoint(), r = this.fillLinearGradientEndPoint(), a = e.createLinearGradient(i.x, i.y, r.x, r.y), n = 0; n < t.length; n += 2)a.addColorStop(t[n], t[n + 1]);
                        return a;
                    }
                }
                _getRadialGradient() {
                ...
                __getRadialGradient() {
                    ...
                    if (t) {
                        for(var e = Nt(), i = this.fillRadialGradientStartPoint(), r = this.fillRadialGradientEndPoint(), a = e.createRadialGradient(i.x, i.y, this.fillRadialGradientStartRadius(), r.x, r.y, this.fillRadialGradientEndRadius()), n = 0; n < t.length; n += 2)a.addColorStop(t[n], t[n + 1]);
                        return a;
                    }
                }
                getShadowRGBA() {
                ...
                getClientRect(t = {
                    ...
                    const e = t.skipTransform, i = t.relativeTo, r = this.getSelfRect(), a = !t.skipStroke && this.hasStroke() && this.strokeWidth() || 0, n = r.width + a, s = r.height + a, o = !t.skipShadow && this.hasShadow(), h = o ? this.shadowOffsetX() : 0, l = o ? this.shadowOffsetY() : 0, d = n + Math.abs(h), c = s + Math.abs(l), g = o && this.shadowBlur() || 0, u = d + 2 * g, f = c + 2 * g;
                    let p = 0;
                ...
                drawHitFromCache(t = 0) {
                    var e, i, r, a, n, s = this._getCanvasCache(), o = this._getCachedSceneCanvas(), h = s.hit, l = h.getContext(), d = h.getWidth(), c = h.getHeight();
                    ...
                    try {
                        ...
                        g.error("Unable to draw hit graph from cached scene canvas. " + t2.message);
                    }
                    return this;
                }
                hasPointerCapture(t) {
            ...
            zt.prototype._fillFunc = function(t) {
                ...
                t.stroke();
            }, zt.prototype._centroid = !1, zt.prototype.nodeType = "Shape", r1(zt), zt.prototype.eventListeners = {
            }, zt.prototype.on.call(zt.prototype, "shadowColorChange.konva shadowBlurChange.konva shadowOffsetChange.konva shadowOpacityChange.konva shadowEnabledChange.konva", function() {
                this._clearCache(Rt);
                ...
                "x",
                "y"
            ]), w.addGetterSetter(zt, "shadowOffsetX", 0, p()), w.addGetterSetter(zt, "shadowOffsetY", 0, p()), w.addGetterSetter(zt, "fillPatternImage"), w.addGetterSetter(zt, "fill", void 0, y()), w.addGetterSetter(zt, "fillPatternX", 0, p()), w.addGetterSetter(zt, "fillPatternY", 0, p()), w.addGetterSetter(zt, "fillLinearGradientColorStops"), w.addGetterSetter(zt, "strokeLinearGradientColorStops"), w.addGetterSetter(zt, "fillRadialGradientStartRadius", 0), w.addGetterSetter(zt, "fillRadialGradientEndRadius", 0), w.addGetterSetter(zt, "fillRadialGradientColorStops"), w.addGetterSetter(zt, "fillPatternRepeat", "repeat"), w.addGetterSetter(zt, "fillEnabled", !0), w.addGetterSetter(zt, "strokeEnabled", !0), w.addGetterSetter(zt, "shadowEnabled", !0), w.addGetterSetter(zt, "dashEnabled", !0), w.addGetterSetter(zt, "strokeScaleEnabled", !0), w.addGetterSetter(zt, "fillPriority", "color"), w.addComponentsGetterSetter(zt, "fillPatternOffset", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillPatternOffsetX", 0, p()), w.addGetterSetter(zt, "fillPatternOffsetY", 0, p()), w.addComponentsGetterSetter(zt, "fillPatternScale", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillPatternScaleX", 1, p()), w.addGetterSetter(zt, "fillPatternScaleY", 1, p()), w.addComponentsGetterSetter(zt, "fillLinearGradientStartPoint", [
                "x",
                "y"
            ]), w.addComponentsGetterSetter(zt, "strokeLinearGradientStartPoint", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillLinearGradientStartPointX", 0), w.addGetterSetter(zt, "strokeLinearGradientStartPointX", 0), w.addGetterSetter(zt, "fillLinearGradientStartPointY", 0), w.addGetterSetter(zt, "strokeLinearGradientStartPointY", 0), w.addComponentsGetterSetter(zt, "fillLinearGradientEndPoint", [
                "x",
                "y"
            ]), w.addComponentsGetterSetter(zt, "strokeLinearGradientEndPoint", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillLinearGradientEndPointX", 0), w.addGetterSetter(zt, "strokeLinearGradientEndPointX", 0), w.addGetterSetter(zt, "fillLinearGradientEndPointY", 0), w.addGetterSetter(zt, "strokeLinearGradientEndPointY", 0), w.addComponentsGetterSetter(zt, "fillRadialGradientStartPoint", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillRadialGradientStartPointX", 0), w.addGetterSetter(zt, "fillRadialGradientStartPointY", 0), w.addComponentsGetterSetter(zt, "fillRadialGradientEndPoint", [
                "x",
                "y"
            ]), w.addGetterSetter(zt, "fillRadialGradientEndPointX", 0), w.addGetterSetter(zt, "fillRadialGradientEndPointY", 0), w.addGetterSetter(zt, "fillPatternRotation", 0), w.backCompat(zt, {
                dashArray: "dash",
            ...
            class Yt extends J {
                constructor(t){
                    super(t), this.canvas = new E, this.hitCanvas = new R({
                        pixelRatio: 1
                ...
                _toKonvaCanvas(t) {
                    return (t = t || {
                    }).width = t.width || this.getWidth(), t.height = t.height || this.getHeight(), t.x = void 0 !== t.x ? t.x : this.x(), t.y = void 0 !== t.y ? t.y : this.y(), K.prototype._toKonvaCanvas.call(this, t);
                }
                _checkVisibility() {
                ...
                getIntersection(t) {
                    ...
                    for(var e = 1, i = !1;;){
                        for(let r = 0; r < Ht; r++){
                            const a = Wt[r], n = this._getIntersection({
                                x: t.x + a.x * e,
                                y: t.y + a.y * e
                            }), s = n.shape;
                            if (s) return s;
                ...
                _getIntersection(t) {
                    ...
                    if (255 === r) {
                        const t = g._rgbToHex(i[0], i[1], i[2]), e = Bt["#" + t];
                        return e ? {
                            shape: e
                        } : {
                            antialiased: !0
                ...
                drawScene(t, e) {
                    ...
                    return this._fire("beforeDraw", {
                        node: this
                    }), this.clearBeforeDraw() && r.getContext().clear(), J.prototype.drawScene.call(this, r, e), this._fire("draw", {
                        node: this
                    }), this;
                }
                drawHit(t, e) {
            ...
            Yt.prototype.nodeType = "Layer", r1(Yt), w.addGetterSetter(Yt, "imageSmoothingEnabled", !0), w.addGetterSetter(Yt, "clearBeforeDraw", !0), w.addGetterSetter(Yt, "hitGraphEnabled", !0, x());
            class Xt extends Yt {
                constructor(t){
                    super(t), this.listening(!1), g.warn('Konva.Fast layer is deprecated. Please use "new Konva.Layer({ listening: false })" instead.');
                }
            }
            Xt.prototype.nodeType = "FastLayer", r1(Xt);
            class jt extends J {
                _validateAdd(t) {
                    var e = t.getType();
            ...
            jt.prototype.nodeType = "Group", r1(jt);
            var Ut = e1.performance && e1.performance.now ? function() {
                return e1.performance.now();
            } : function() {
                return (new Date).getTime();
            };
            class qt {
                constructor(t, e){
                    this.id = qt.animIdCounter++, this.frame = {
                        time: 0,
                        timeDiff: 0,
                        lastTime: Ut(),
                        frameRate: 0
                ...
                isRunning() {
                    var t, e = qt.animations, i = e.length;
                ...
                _updateFrameObject(t) {
                    this.frame.timeDiff = t - this.frame.lastTime, this.frame.lastTime = t, this.frame.time += this.frame.timeDiff, this.frame.frameRate = 1000 / this.frame.timeDiff;
                }
                ...
                static _runFrames() {
                    ...
                    for(r = 0; r < l.length; r++)if (e = (t = l[r]).layers, i = t.func, t._updateFrameObject(Ut()), n = e.length, !i || !1 !== i.call(t, t.frame)) for(a = 0; a < n; a++)void 0 !== (s = e[a])._id && (h[s._id] = s);
            ...
            class Zt {
                constructor(t){
                    var e, r, a = this, n = t.node, s = n._id, o = t.easing || $t.Linear, h = !!t.yoyo;
                    e = void 0 === t.duration ? 0.3 : 0 === t.duration ? 0.001 : t.duration, this.node = n, this._id = Kt++;
                    var l = n.getLayer() || (n instanceof i1.Stage ? n.getLayers() : null);
                    for(r in l || g.error("Tween constructor have `node` that is not in a layer. Please add node into layer first."), this.anim = new qt(function() {
                        a.tween.onEnterFrame();
                    }, l), this.tween = new Jt(r, function(t) {
                        a._tweenFunc(t);
                    }, o, 0, 1, 1000 * e, h), this._addListeners(), Zt.attrs[s] || (Zt.attrs[s] = {
                    }), Zt.attrs[s][this._id] || (Zt.attrs[s][this._id] = {
                    }), Zt.tweens[s] || (Zt.tweens[s] = {
                    }), t)void 0 === Vt[r] && this._addAttr(r, t[r]);
                    this.reset(), this.onFinish = t.onFinish, this.onReset = t.onReset, this.onUpdate = t.onUpdate;
                }
                _addAttr(t, e) {
                    var i, r, a, n, s, o, h, l, d = this.node, c = d._id;
                    if ((a = Zt.tweens[c][t]) && delete Zt.attrs[c][a][t], i = d.getAttr(t), g._isArray(e)) {
                        if (r = [], s = Math.max(e.length, i.length), "points" === t && e.length !== i.length && (e.length > i.length ? (h = i, i = g._prepareArrayForTween(i, e, d.closed())) : (o = e, e = g._prepareArrayForTween(e, i, d.closed()))), 0 === t.indexOf("fill")) for(n = 0; n < s; n++)if (n % 2 == 0) r.push(e[n] - i[n]);
                        else {
                    ...
                    } else -1 !== Qt.indexOf(t) ? (i = g.colorToRGBA(i), r = {
                        r: (l = g.colorToRGBA(e)).r - i.r,
                        g: l.g - i.g,
                        b: l.b - i.b,
                        a: l.a - i.a
                    }) : r = e - i;
                    Zt.attrs[c][this._id][t] = {
                        start: i,
                        diff: r,
                        end: e,
                        trueEnd: o,
                        trueStart: h
                    }, Zt.tweens[c][t] = this._id;
                }
                _tweenFunc(t) {
                    var e, i, r, a, n, s, o, h, l = this.node, d = Zt.attrs[l._id][this._id];
                    for(e in d){
                        if (r = (i = d[e]).start, a = i.diff, h = i.end, g._isArray(r)) {
                            if (n = [], o = Math.max(r.length, h.length), 0 === e.indexOf("fill")) for(s = 0; s < o; s++)s % 2 == 0 ? n.push((r[s] || 0) + a[s] * t) : n.push("rgba(" + Math.round(r[s].r + a[s].r * t) + "," + Math.round(r[s].g + a[s].g * t) + "," + Math.round(r[s].b + a[s].b * t) + "," + (r[s].a + a[s].a * t) + ")");
                            else for(s = 0; s < o; s++)n.push((r[s] || 0) + a[s] * t);
                        } else n = -1 !== Qt.indexOf(e) ? "rgba(" + Math.round(r.r + a.r * t) + "," + Math.round(r.g + a.g * t) + "," + Math.round(r.b + a.b * t) + "," + (r.a + a.a * t) + ")" : r + a * t;
                        l.setAttr(e, n);
                    }
                }
                _addListeners() {
                    this.tween.onPlay = ()=>{
                        ...
                        var t = this.node, e = Zt.attrs[t._id][this._id];
                ...
                seek(t) {
                    return this.tween.seek(1000 * t), this;
                }
                pause() {
                ...
                destroy() {
                    var t, e = this.node._id, i = this._id, r = Zt.tweens[e];
            ...
            const $t = {
                ...
                ElasticEaseIn (t, e, i, r, a, n) {
                    var s = 0;
                    return 0 === t ? e : 1 == (t /= r) ? e + i : (n || (n = 0.3 * r), !a || a < Math.abs(i) ? (a = i, s = n / 4) : s = n / (2 * Math.PI) * Math.asin(i / a), -a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * r - s) * (2 * Math.PI) / n) + e);
                },
                ...
                ElasticEaseInOut (t, e, i, r, a, n) {
                    var s = 0;
                    return 0 === t ? e : 2 == (t /= r / 2) ? e + i : (n || (n = r * (0.3 * 1.5)), !a || a < Math.abs(i) ? (a = i, s = n / 4) : s = n / (2 * Math.PI) * Math.asin(i / a), t < 1 ? a * Math.pow(2, 10 * (t -= 1)) * Math.sin((t * r - s) * (2 * Math.PI) / n) * -0.5 + e : a * Math.pow(2, -10 * (t -= 1)) * Math.sin((t * r - s) * (2 * Math.PI) / n) * 0.5 + i + e);
                },
                BounceEaseOut: (t, e, i, r)=>(t /= r) < 1 / 2.75 ? i * (7.5625 * t * t) + e : t < 2 / 2.75 ? i * (7.5625 * (t -= 1.5 / 2.75) * t + 0.75) + e : t < 2.5 / 2.75 ? i * (7.5625 * (t -= 2.25 / 2.75) * t + 0.9375) + e : i * (7.5625 * (t -= 2.625 / 2.75) * t + 0.984375) + e
                ,
            ...
            class ee extends zt {
                _sceneFunc(t) {
                    var e = i1.getAngle(this.angle()), r = this.clockwise();
                ...
                getSelfRect() {
                    const t = this.innerRadius(), e = this.outerRadius(), r = this.clockwise(), a = i1.getAngle(r ? 360 - this.angle() : this.angle()), n = Math.cos(Math.min(a, Math.PI)), s = Math.sin(Math.min(Math.max(Math.PI, a), 3 * Math.PI / 2)), o = Math.sin(Math.min(a, Math.PI / 2)), h = n * (n > 0 ? t : e), l = 1 * e, d = s * (s > 0 ? t : e), c = o * (o > 0 ? e : t);
                    return {
                        x: Math.round(h),
                        y: Math.round(r ? -1 * c : d),
                        width: Math.round(l - h),
            ...
            function re(t, e) {
                ...
                for(i = 2; i < a - 2; i += 2)r = ie(t[i - 2], t[i - 1], t[i], t[i + 1], t[i + 2], t[i + 3], e), isNaN(r[0]) || (n.push(r[0]), n.push(r[1]), n.push(t[i]), n.push(t[i + 1]), n.push(r[2]), n.push(r[3]));
                return n;
            }
            ee.prototype._centroid = !0, ee.prototype.className = "Arc", ee.prototype._attrsAffectingSize = [
                "innerRadius",
                "outerRadius"
            ], r1(ee), w.addGetterSetter(ee, "innerRadius", 0, p()), w.addGetterSetter(ee, "outerRadius", 0, p()), w.addGetterSetter(ee, "angle", 0, p()), w.addGetterSetter(ee, "clockwise", !1, x());
            class ae extends zt {
                constructor(t){
                ...
                _getTensionPointsClosed() {
                    var t = this.points(), e = t.length, i = this.tension(), r = ie(t[e - 2], t[e - 1], t[0], t[1], t[2], t[3], i), a = ie(t[e - 4], t[e - 3], t[e - 2], t[e - 1], t[0], t[1], i), n = re(t, i);
                    return [
                        r[2],
                        r[3]
                    ].concat(n).concat([
            ...
            ae.prototype.className = "Line", ae.prototype._attrsAffectingSize = [
                "points",
                "bezier",
                "tension"
            ], r1(ae), w.addGetterSetter(ae, "closed", !1), w.addGetterSetter(ae, "bezier", !1), w.addGetterSetter(ae, "tension", 0, p()), w.addGetterSetter(ae, "points", [], function() {
                if (i1.isUnminified) return function(t, e) {
                    return g._isArray(t) ? t.forEach(function(t) {
            ...
            class ne extends zt {
                ...
                getSelfRect() {
                    ...
                    this.dataArray.forEach(function(e) {
                        if ("A" === e.command) {
                            ...
                            if (Math.abs(i - a) < n && (n = Math.abs(i - a)), r < 0) for(let r2 = i - n; r2 > a; r2 -= n){
                                const i = ne.getPointOnEllipticalArc(e.points[0], e.points[1], e.points[2], e.points[3], r2, 0);
                                t.push(i.x, i.y);
                            }
                            else for(let r3 = i + n; r3 < a; r3 += n){
                                const i = ne.getPointOnEllipticalArc(e.points[0], e.points[1], e.points[2], e.points[3], r3, 0);
                                t.push(i.x, i.y);
                            }
                        } else if ("C" === e.command) for(let i = 0; i <= 1; i += 0.01){
                            const r = ne.getPointOnCubicBezier(i, e.start.x, e.start.y, e.points[0], e.points[1], e.points[2], e.points[3], e.points[4], e.points[5]);
                            t.push(r.x, r.y);
                        }
                ...
                static getPointOnLine(t, e, i, r, a, n, s) {
                    ...
                    var o = (a - i) / (r - e + 0.00000001), h = Math.sqrt(t * t / (1 + o * o));
                    r < e && (h *= -1);
                    var l, d = o * h;
                    if (r === e) l = {
                        x: n,
                    ...
                    else if ((s - i) / (n - e + 0.00000001) === o) l = {
                        x: n + h,
                        y: s + d
                    };
                    else {
                ...
                static calcLength(t, e, i, r) {
                    ...
                    switch(i){
                        ...
                        case "C":
                            for(a = 0, n = h.getPointOnCubicBezier(0, t, e, r[0], r[1], r[2], r[3], r[4], r[5]), o = 0.01; o <= 1; o += 0.01)s = h.getPointOnCubicBezier(o, t, e, r[0], r[1], r[2], r[3], r[4], r[5]), a += h.getLineLength(n.x, n.y, s.x, s.y), n = s;
                            return a;
                        case "Q":
                            for(a = 0, n = h.getPointOnQuadraticBezier(0, t, e, r[0], r[1], r[2], r[3]), o = 0.01; o <= 1; o += 0.01)s = h.getPointOnQuadraticBezier(o, t, e, r[0], r[1], r[2], r[3]), a += h.getLineLength(n.x, n.y, s.x, s.y), n = s;
                            return a;
                        case "A":
                            a = 0;
                ...
                static convertEndpointToCenterParameterization(t, e, i, r, a, n, s, o, h) {
                    ...
                    a === n && (u *= -1), isNaN(u) && (u = 0);
                    var f = u * s * c / o, p = u * -o * d / s, v = (t + i) / 2 + Math.cos(l) * f - Math.sin(l) * p, m = (e + r) / 2 + Math.sin(l) * f + Math.cos(l) * p, _ = function(t) {
                    ...
                    return y(S, w) <= -1 && (C = Math.PI), y(S, w) >= 1 && (C = 0), 0 === n && C > 0 && (C -= 2 * Math.PI), 1 === n && C < 0 && (C += 2 * Math.PI), [
                        v,
                        m,
                        s,
                        o,
            ...
            ne.prototype.className = "Path", ne.prototype._attrsAffectingSize = [
                "data"
            ], r1(ne), w.addGetterSetter(ne, "data");
            class se extends ae {
                _sceneFunc(t) {
                    super._sceneFunc(t);
                    ...
                    if (a) {
                        const t = [
                            ...
                            i[h - 2],
                            i[h - 1]
                        ], e = ne.calcLength(r[r.length - 4], r[r.length - 3], "C", t), a = ne.getPointOnQuadraticBezier(Math.min(1, 1 - o / e), t[0], t[1], t[2], t[3], t[4], t[5]);
            ...
            se.prototype.className = "Arrow", r1(se), w.addGetterSetter(se, "pointerLength", 10, p()), w.addGetterSetter(se, "pointerWidth", 10, p()), w.addGetterSetter(se, "pointerAtBeginning", !1), w.addGetterSetter(se, "pointerAtEnding", !0);
            class oe extends zt {
                _sceneFunc(t) {
            ...
            oe.prototype._centroid = !0, oe.prototype.className = "Circle", oe.prototype._attrsAffectingSize = [
                "radius"
            ], r1(oe), w.addGetterSetter(oe, "radius", 0, p());
            class he extends zt {
                _sceneFunc(t) {
            ...
            he.prototype.className = "Ellipse", he.prototype._centroid = !0, he.prototype._attrsAffectingSize = [
                "radiusX",
                "radiusY"
            ], r1(he), w.addComponentsGetterSetter(he, "radius", [
                "x",
                "y"
            ]), w.addGetterSetter(he, "radiusX", 0, p()), w.addGetterSetter(he, "radiusY", 0, p());
            class le extends zt {
                constructor(t){
                ...
                _sceneFunc(t) {
                    const e = this.getWidth(), i = this.getHeight(), r = this.attrs.image;
                    let a;
                    if (r) {
                        const t = this.attrs.cropWidth, n = this.attrs.cropHeight;
                        a = t && n ? [
                            r,
                            this.cropX(),
                            this.cropY(),
            ...
            le.prototype.className = "Image", r1(le), w.addGetterSetter(le, "image"), w.addComponentsGetterSetter(le, "crop", [
                "x",
                "y",
                "width",
                "height"
            ]), w.addGetterSetter(le, "cropX", 0, p()), w.addGetterSetter(le, "cropY", 0, p()), w.addGetterSetter(le, "cropWidth", 0, p()), w.addGetterSetter(le, "cropHeight", 0, p());
            var de = [
                "fontFamily",
                "fontSize",
                "fontStyle",
                ...
                "width",
                "height"
            ], ce = "up", ge = "right", ue = "down", fe = "left", pe = de.length;
            class ve extends jt {
                constructor(t){
            ...
            ve.prototype.className = "Label", r1(ve);
            class me extends zt {
                _sceneFunc(t) {
                ...
                getSelfRect() {
                    ...
                    return a === ce ? (e -= r, s += r) : a === ue ? s += r : a === fe ? (t -= 1.5 * i, n += i) : a === ge && (n += 1.5 * i), {
                        x: t,
                        y: e,
                        width: n,
                        height: s
            ...
            me.prototype.className = "Tag", r1(me), w.addGetterSetter(me, "pointerDirection", "none"), w.addGetterSetter(me, "pointerWidth", 0, p()), w.addGetterSetter(me, "pointerHeight", 0, p()), w.addGetterSetter(me, "cornerRadius", 0, v(4));
            class _e extends zt {
                _sceneFunc(t) {
            ...
            _e.prototype.className = "Rect", r1(_e), w.addGetterSetter(_e, "cornerRadius", 0, v(4));
            class ye extends zt {
                _sceneFunc(t) {
            ...
            ye.prototype.className = "RegularPolygon", ye.prototype._centroid = !0, ye.prototype._attrsAffectingSize = [
                "radius"
            ], r1(ye), w.addGetterSetter(ye, "radius", 0, p()), w.addGetterSetter(ye, "sides", 0, p());
            var xe = 2 * Math.PI;
            class be extends zt {
                _sceneFunc(t) {
                    t.beginPath(), t.arc(0, 0, this.innerRadius(), 0, xe, !1), t.moveTo(this.outerRadius(), 0), t.arc(0, 0, this.outerRadius(), xe, 0, !0), t.closePath(), t.fillStrokeShape(this);
                }
                getWidth() {
                    return 2 * this.outerRadius();
                }
            ...
            be.prototype.className = "Ring", be.prototype._centroid = !0, be.prototype._attrsAffectingSize = [
                "innerRadius",
                "outerRadius"
            ], r1(be), w.addGetterSetter(be, "innerRadius", 0, p()), w.addGetterSetter(be, "outerRadius", 0, p());
            class Se extends zt {
                constructor(t){
                    super(t), this._updated = !0, this.anim = new qt(()=>{
                        var t = this._updated;
            ...
            Se.prototype.className = "Sprite", r1(Se), w.addGetterSetter(Se, "animation"), w.addGetterSetter(Se, "animations"), w.addGetterSetter(Se, "frameOffsets"), w.addGetterSetter(Se, "image"), w.addGetterSetter(Se, "frameIndex", 0, p()), w.addGetterSetter(Se, "frameRate", 17, p()), w.backCompat(Se, {
                index: "frameIndex",
            ...
            we.prototype.className = "Star", we.prototype._centroid = !0, we.prototype._attrsAffectingSize = [
                "innerRadius",
                "outerRadius"
            ], r1(we), w.addGetterSetter(we, "numPoints", 5, p()), w.addGetterSetter(we, "innerRadius", 0, p()), w.addGetterSetter(we, "outerRadius", 0, p());
            var Pe, ke = "auto", Te = "justify", Ae = "left", Me = "middle", Ge = "normal", Ee = " ", Re = [
                "fontFamily",
                "fontSize",
                "fontStyle",
                "fontVariant",
            ...
            class Oe extends zt {
                constructor(t){
                    super(function(t) {
                        return (t = t || {
                        }).fillLinearGradientColorStops || t.fillRadialGradientColorStops || t.fillPatternImage || (t.fill = t.fill || "black"), t;
                ...
                _sceneFunc(t) {
                    ...
                    if (this.text()) {
                        ...
                        for(t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", Me), t.setAttr("textAlign", Ae), o === Me ? h = (this.getHeight() - i * s - 2 * a) / 2 : "bottom" === o && (h = this.getHeight() - i * s - 2 * a), t.translate(a, h + a), r = 0; r < i; r++){
                            m = 0, _ = 0;
                            var y, x, b, S = e[r], w = S.text, C = S.width, P = S.lastInParagraph;
                            if (t.save(), "right" === l ? m += d - C - 2 * a : "center" === l && (m += (d - C - 2 * a) / 2), f && (t.save(), t.beginPath(), t.moveTo(m, v + _ + Math.round(n / 2)), x = 0 === (y = w.split(" ").length - 1), b = l === Te && P && !x ? d - 2 * a : C, t.lineTo(m + Math.round(b), v + _ + Math.round(n / 2)), t.lineWidth = n / 15, t.strokeStyle = g, t.stroke(), t.restore()), p && (t.save(), t.beginPath(), t.moveTo(m, v + _), x = 0 === (y = w.split(" ").length - 1), b = l === Te && P && !x ? d - 2 * a : C, t.lineTo(m + Math.round(b), v + _), t.lineWidth = n / 15, t.strokeStyle = g, t.stroke(), t.restore()), 0 !== c || l === Te) {
                                y = w.split(" ").length - 1;
                                for(var k = Ce(w), T = 0; T < k.length; T++){
                                    var A = k[T];
                                    " " !== A || P || l !== Te || (m += (d - 2 * a - C) / y), this._partialTextX = m, this._partialTextY = v + _, this._partialText = A, t.fillStrokeShape(this), m += this.measureSize(A).width + c;
                                }
                ...
                _getContextFont() {
                    return this.fontStyle() + Ee + this.fontVariant() + Ee + (this.fontSize() + "px ") + this.fontFamily().split(",").map((t)=>{
                ...
                _setTextData() {
                    var t = this.text().split("\n"), e = +this.fontSize(), i = 0, r = this.lineHeight() * e, a = this.attrs.width, n = this.attrs.height, s = a !== ke && void 0 !== a, o = n !== ke && void 0 !== n, h = this.padding(), l = a - 2 * h, d = n - 2 * h, c = 0, g = this.wrap(), u = "none" !== g, f = "char" !== g && u, p = this.ellipsis();
                    this.textArr = [], De().font = this._getContextFont();
                    for(var v = p ? this._getTextWidth("…") : 0, m = 0, _ = t.length; m < _; ++m){
                        var y = t[m], x = this._getTextWidth(y);
                        if (s && x > l) for(; y.length > 0;){
                            for(var b = 0, S = y.length, w = "", C = 0; b < S;){
                                var P = b + S >>> 1, k = y.slice(0, P + 1), T = this._getTextWidth(k) + v;
                                T <= l ? (b = P + 1, w = k, C = T) : S = P;
                            }
                            if (!w) break;
                            if (f) {
                                var A, M = y[w.length];
                                (A = (M === Ee || "-" === M) && C <= l ? w.length : Math.max(w.lastIndexOf(Ee), w.lastIndexOf("-")) + 1) > 0 && (b = A, w = w.slice(0, b), C = this._getTextWidth(w));
                            }
            ...
            }, Oe.prototype.className = "Text", Oe.prototype._attrsAffectingSize = [
                "text",
                "fontSize",
                "padding",
                "wrap",
            ...
            class Be extends zt {
                constructor(t){
                    super(t), this.dummyCanvas = g.createCanvasElement(), this.dataArray = [], this.dataArray = ne.parsePathData(this.attrs.data), this.on("dataChange.konva", function() {
                ...
                _setTextData() {
                    ...
                    for(var l, d, c, g = Ce(this.text()), u = this.text().split(" ").length - 1, f = -1, p = 0, v = function() {
                        p = 0;
                        ...
                        for(d = void 0; Math.abs(a - o) / a > 0.01 && h < 20;){
                            ...
                            switch(c.command){
                                case "L":
                                    ne.getLineLength(l.x, l.y, c.points[0], c.points[1]) > a ? d = ne.getPointOnLine(a, l.x, l.y, c.points[0], c.points[1], l.x, l.y) : c = void 0;
                                    break;
                                case "A":
                                    var m = c.points[4], _ = c.points[5], y = c.points[4] + _;
                                    0 === p ? p = m + 0.00000001 : a > o ? p += Math.PI / 180 * _ / Math.abs(_) : p -= Math.PI / 360 * _ / Math.abs(_), (_ < 0 && p < y || _ >= 0 && p > y) && (p = y, f = !0), d = ne.getPointOnEllipticalArc(c.points[0], c.points[1], c.points[2], c.points[3], p, c.points[6]);
                                    break;
                                case "C":
                                    0 === p ? p = a > c.pathLength ? 0.00000001 : a / c.pathLength : a > o ? p += (a - o) / c.pathLength / 2 : p = Math.max(p - (o - a) / c.pathLength / 2, 0), p > 1 && (p = 1, f = !0), d = ne.getPointOnCubicBezier(p, c.start.x, c.start.y, c.points[0], c.points[1], c.points[2], c.points[3], c.points[4], c.points[5]);
                                    break;
                                case "Q":
                                    0 === p ? p = a / c.pathLength : a > o ? p += (a - o) / c.pathLength : p -= (o - a) / c.pathLength, p > 1 && (p = 1, f = !0), d = ne.getPointOnQuadraticBezier(p, c.start.x, c.start.y, c.points[0], c.points[1], c.points[2], c.points[3]);
                            }
                    ...
                    for(var x = 0; x < g.length && (m(g[x]), void 0 !== l && void 0 !== d); x++){
                        var b = ne.getLineLength(l.x, l.y, d.x, d.y), S = 0;
                        if (a) try {
                        ...
                        var w = ne.getPointOnLine(S + b / 2, l.x, l.y, d.x, d.y), C = Math.atan2(d.y - l.y, d.x - l.x);
                        this.glyphInfo.push({
                            transposeX: w.x,
                            transposeY: w.y,
                            text: g[x],
            ...
            Be.prototype._fillFunc = Fe, Be.prototype._strokeFunc = Ne, Be.prototype._fillFuncHit = Fe, Be.prototype._strokeFuncHit = Ne, Be.prototype.className = "TextPath", Be.prototype._attrsAffectingSize = [
                "text",
                "fontSize",
                "data"
            ], r1(Be), w.addGetterSetter(Be, "data"), w.addGetterSetter(Be, "fontFamily", "Arial"), w.addGetterSetter(Be, "fontSize", 12, p()), w.addGetterSetter(Be, "fontStyle", Ie), w.addGetterSetter(Be, "align", "left"), w.addGetterSetter(Be, "letterSpacing", 0, p()), w.addGetterSetter(Be, "textBaseline", "middle"), w.addGetterSetter(Be, "fontVariant", Ie), w.addGetterSetter(Be, "text", ""), w.addGetterSetter(Be, "textDecoration", null), w.addGetterSetter(Be, "kerningFunc", null);
            var ze = "tr-konva", We = [
                "resizeEnabledChange",
            ...
            const je = "ontouchstart" in i1._global;
            var Ue = [
                "top-left",
                "top-center",
                "top-right",
            ...
            function qe(t, e, i) {
                const r = i.x + (t.x - i.x) * Math.cos(e) - (t.y - i.y) * Math.sin(e), a = i.y + (t.x - i.x) * Math.sin(e) + (t.y - i.y) * Math.cos(e);
            ...
            class Ke extends jt {
                constructor(t){
                    super(t), this._transforming = !1, this._createElements(), this._handleMouseMove = this._handleMouseMove.bind(this), this._handleMouseUp = this._handleMouseUp.bind(this), this.update = this.update.bind(this), this.on(We, this.update), this.getNode() && this.update();
                }
                attachTo(t) {
                    return this.setNode(t), this;
                }
                setNode(t) {
                    return g.warn("tr.setNode(shape), tr.node(shape) and tr.attachTo(shape) methods are deprecated. Please use tr.nodes(nodesArray) instead."), this.setNodes([
                        t
                    ]);
                }
                getNode() {
                ...
                setNodes(t = []) {
                    return this._nodes && this._nodes.length && this.detach(), this._nodes = t, 1 === t.length && this.useSingleNodeRotation() ? this.rotation(t[0].getAbsoluteRotation()) : this.rotation(0), this._nodes.forEach((t)=>{
                        const e = ()=>{
                        ...
                        }, i = t._attrsAffectingSize.map((t)=>t + "Change." + this._getEventNamespace()
                        ).join(" ");
                        t.on(i, e), t.on(Ye.map((t)=>t + `.${this._getEventNamespace()}`
                        ).join(" "), e), t.on(`absoluteTransformChange.${this._getEventNamespace()}`, e), this._proxyDrag(t);
                ...
                __getNodeShape(t, e = this.rotation(), r) {
                    ...
                    const l = (i1.getAngle(t.getAbsoluteRotation()) + 2 * Math.PI) % (2 * Math.PI);
                    return qe({
                ...
                __getNodeRect() {
                    ...
                    const e = new a1;
                    var r, n, s, o;
                    e.rotate(-i1.getAngle(this.rotation())), t.forEach(function(t) {
                        var i = e.point(t);
                    ...
                    return {
                        ...
                        width: s - r,
                        height: o - n,
                        rotation: i1.getAngle(this.rotation())
                    };
                }
                getX() {
                ...
                _createElements() {
                    this._createBack(), Ue.forEach((function(t) {
                ...
                _createBack() {
                    var t2 = new zt({
                        ...
                        sceneFunc (t) {
                            ...
                            t.beginPath(), t.rect(-i, -i, this.width() + 2 * i, this.height() + 2 * i), t.moveTo(this.width() / 2, -i), e.rotateEnabled() && t.lineTo(this.width() / 2, -e.rotateAnchorOffset() * g._sign(this.height()) - i), t.fillStrokeShape(this);
                        },
                        hitFunc: (t, e)=>{
                    ...
                    this.add(t2), this._proxyDrag(t2), t2.on("dragstart", (t)=>{
                        t.cancelBubble = !0;
                    }), t2.on("dragmove", (t)=>{
                        t.cancelBubble = !0;
                    }), t2.on("dragend", (t)=>{
                        ...
                        if ("rotater" !== this._movingAnchorName) {
                            ...
                            if ("top-left" === this._movingAnchorName) {
                                if (c) {
                                    ...
                                    var f = this.findOne(".top-left").x() > u.x ? -1 : 1, p = this.findOne(".top-left").y() > u.y ? -1 : 1;
                            ...
                            if (g = this.centeredScaling() || t.altKey) {
                                var m = this.findOne(".top-left"), _ = this.findOne(".bottom-right"), y = m.x(), x = m.y(), b = this.getWidth() - _.x(), S = this.getHeight() - _.y();
                                _.move({
                                    x: -y,
                                    y: -x
                                }), m.move({
                            ...
                            e = w.x, r = w.y;
                            var C = this.findOne(".bottom-right").x() - this.findOne(".top-left").x(), P = this.findOne(".bottom-right").y() - this.findOne(".top-left").y();
                            this._fitNodesInto({
                                x: e,
                                y: r,
                                width: C,
                            ...
                            e = n.x() - k.width / 2, r = -n.y() + k.height / 2;
                            let a = Math.atan2(-r, e) + Math.PI / 2;
                            k.height < 0 && (a -= Math.PI);
                            const s = i1.getAngle(this.rotation()) + a, o = i1.getAngle(this.rotationSnapTolerance()), h = function(t, e, r) {
                                let a = e;
                                for(let n = 0; n < t.length; n++){
                                    const s = i1.getAngle(t[n]), o = Math.abs(s - e) % (2 * Math.PI);
                                    Math.min(o, 2 * Math.PI - o) < r && (a = s);
                                }
                                return a;
                            }(this.rotationSnaps(), s, o), l = Ve(k, h - k.rotation);
                ...
                _fitNodesInto(t, e) {
                    ...
                    var s = new a1;
                    if (s.rotate(i1.getAngle(this.rotation())), this._movingAnchorName && t.width < 0 && this._movingAnchorName.indexOf("left") >= 0) {
                        const e = s.point({
                            x: 2 * -this.padding(),
                            y: 0
                        });
                        if (t.x += e.x, t.y += e.y, t.width += 2 * this.padding(), this._movingAnchorName = this._movingAnchorName.replace("left", "right"), this._anchorDragOffset.x -= e.x, this._anchorDragOffset.y -= e.y, !n) return void this.update();
                    } else if (this._movingAnchorName && t.width < 0 && this._movingAnchorName.indexOf("right") >= 0) {
                        const e = s.point({
                            x: 2 * this.padding(),
                            y: 0
                        });
                        if (this._movingAnchorName = this._movingAnchorName.replace("right", "left"), this._anchorDragOffset.x -= e.x, this._anchorDragOffset.y -= e.y, t.width += 2 * this.padding(), !n) return void this.update();
                    }
                    if (this._movingAnchorName && t.height < 0 && this._movingAnchorName.indexOf("top") >= 0) {
                        ...
                        if (t.x += e.x, t.y += e.y, this._movingAnchorName = this._movingAnchorName.replace("top", "bottom"), this._anchorDragOffset.x -= e.x, this._anchorDragOffset.y -= e.y, t.height += 2 * this.padding(), !n) return void this.update();
                    } else if (this._movingAnchorName && t.height < 0 && this._movingAnchorName.indexOf("bottom") >= 0) {
                        const e = s.point({
                            x: 0,
                            y: 2 * this.padding()
                        });
                        if (this._movingAnchorName = this._movingAnchorName.replace("bottom", "top"), this._anchorDragOffset.x -= e.x, this._anchorDragOffset.y -= e.y, t.height += 2 * this.padding(), !n) return void this.update();
                    }
                    if (this.boundBoxFunc()) {
                        const e = this.boundBoxFunc()(r, t);
                        e ? t = e : g.warn("boundBoxFunc returned falsy. You should return new bound rect from it!");
                    }
                    const o = 10000000, h = new a1;
                    ...
                    this._nodes.forEach((t)=>{
                        var i;
                        const r = t.getParent().getAbsoluteTransform(), n = t.getTransform().copy();
            ...
            Ke.prototype.className = "Transformer", r1(Ke), w.addGetterSetter(Ke, "enabledAnchors", Ue, function(t) {
            ...
            class Qe extends zt {
                _sceneFunc(t) {
                    t.beginPath(), t.arc(0, 0, this.radius(), 0, i1.getAngle(this.angle()), this.clockwise()), t.lineTo(0, 0), t.closePath(), t.fillStrokeShape(this);
                }
                getWidth() {
                    return 2 * this.radius();
                }
            ...
            Qe.prototype.className = "Wedge", Qe.prototype._centroid = !0, Qe.prototype._attrsAffectingSize = [
                "radius"
            ], r1(Qe), w.addGetterSetter(Qe, "radius", 0, p()), w.addGetterSetter(Qe, "angle", 0, p()), w.addGetterSetter(Qe, "clockwise", !1), w.backCompat(Qe, {
                angleDeg: "angle",
            ...
            w.addGetterSetter(K, "embossStrength", 0.5, p(), w.afterSetFilter), w.addGetterSetter(K, "embossWhiteLevel", 0.5, p(), w.afterSetFilter), w.addGetterSetter(K, "embossDirection", "top-left", null, w.afterSetFilter), w.addGetterSetter(K, "embossBlend", !1, null, w.afterSetFilter);
            ...
            w.addGetterSetter(K, "red", 0, function(t) {
                ...
                return this._filterUpToDate = !1, t > 255 ? 255 : t < 0 ? 0 : Math.round(t);
            }), w.addGetterSetter(K, "blue", 0, f, w.afterSetFilter), w.addGetterSetter(K, "alpha", 1, function(t) {
            ...
            return te.Util._assign(te, {
                ...
                Filters: {
                    Blur: function(t) {
                        ...
                        e > 0 && (function(t, e) {
                            var i, r, a, n, s, o, h, l, d, c, g, u, f, p, v, m, _, y, x, b, S, w, C, P, k = t.data, T = t.width, A = t.height, M = e + e + 1, G = T - 1, E = A - 1, R = e + 1, L = R * (R + 1) / 2, D = new Je, O = null, I = D, F = null, N = null, B = Ze[e], z = $e[e];
                            for(a = 1; a < M; a++)I = I.next = new Je, a === R && (O = I);
                            for(I.next = D, h = o = 0, r = 0; r < A; r++){
                                for(m = _ = y = x = l = d = c = g = 0, u = R * (b = k[o]), f = R * (S = k[o + 1]), p = R * (w = k[o + 2]), v = R * (C = k[o + 3]), l += L * b, d += L * S, c += L * w, g += L * C, I = D, a = 0; a < R; a++)I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                                for(a = 1; a < R; a++)n = o + ((G < a ? G : a) << 2), l += (I.r = b = k[n]) * (P = R - a), d += (I.g = S = k[n + 1]) * P, c += (I.b = w = k[n + 2]) * P, g += (I.a = C = k[n + 3]) * P, m += b, _ += S, y += w, x += C, I = I.next;
                                for(F = D, N = O, i = 0; i < T; i++)k[o + 3] = C = g * B >> z, 0 !== C ? (C = 255 / C, k[o] = (l * B >> z) * C, k[o + 1] = (d * B >> z) * C, k[o + 2] = (c * B >> z) * C) : k[o] = k[o + 1] = k[o + 2] = 0, l -= u, d -= f, c -= p, g -= v, u -= F.r, f -= F.g, p -= F.b, v -= F.a, n = h + ((n = i + e + 1) < G ? n : G) << 2, l += m += F.r = k[n], d += _ += F.g = k[n + 1], c += y += F.b = k[n + 2], g += x += F.a = k[n + 3], F = F.next, u += b = N.r, f += S = N.g, p += w = N.b, v += C = N.a, m -= b, _ -= S, y -= w, x -= C, N = N.next, o += 4;
                                h += T;
                            }
                            for(i = 0; i < T; i++){
                                for(_ = y = x = m = d = c = g = l = 0, u = R * (b = k[o = i << 2]), f = R * (S = k[o + 1]), p = R * (w = k[o + 2]), v = R * (C = k[o + 3]), l += L * b, d += L * S, c += L * w, g += L * C, I = D, a = 0; a < R; a++)I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                                for(s = T, a = 1; a <= e; a++)o = s + i << 2, l += (I.r = b = k[o]) * (P = R - a), d += (I.g = S = k[o + 1]) * P, c += (I.b = w = k[o + 2]) * P, g += (I.a = C = k[o + 3]) * P, m += b, _ += S, y += w, x += C, I = I.next, a < E && (s += T);
                                for(o = i, F = D, N = O, r = 0; r < A; r++)k[3 + (n = o << 2)] = C = g * B >> z, C > 0 ? (C = 255 / C, k[n] = (l * B >> z) * C, k[n + 1] = (d * B >> z) * C, k[n + 2] = (c * B >> z) * C) : k[n] = k[n + 1] = k[n + 2] = 0, l -= u, d -= f, c -= p, g -= v, u -= F.r, f -= F.g, p -= F.b, v -= F.a, n = i + ((n = r + R) < E ? n : E) * T << 2, l += m += F.r = k[n], d += _ += F.g = k[n + 1], c += y += F.b = k[n + 2], g += x += F.a = k[n + 3], F = F.next, u += b = N.r, f += S = N.g, p += w = N.b, v += C = N.a, m -= b, _ -= S, y -= w, x -= C, N = N.next, o += T;
                            }
                        })(t, e);
                    },
                    Brighten: function(t) {
                    ...
                    Contrast: function(t) {
                        ...
                        for(e = 0; e < a; e += 4)n = r[e], s = r[e + 1], o = r[e + 2], n /= 255, n -= 0.5, n *= i, n += 0.5, s /= 255, s -= 0.5, s *= i, s += 0.5, o /= 255, o -= 0.5, o *= i, o += 0.5, n = (n *= 255) < 0 ? 0 : n > 255 ? 255 : n, s = (s *= 255) < 0 ? 0 : s > 255 ? 255 : s, o = (o *= 255) < 0 ? 0 : o > 255 ? 255 : o, r[e] = n, r[e + 1] = s, r[e + 2] = o;
                    },
                    Emboss: function(t) {
                        var e = 10 * this.embossStrength(), i = 255 * this.embossWhiteLevel(), r = this.embossDirection(), a = this.embossBlend(), n = 0, s = 0, o = t.data, h = t.width, l = t.height, d = 4 * h, c = l;
                        switch(r){
                            case "top-left":
                                n = -1, s = -1;
                                break;
                    ...
                    Enhance: function(t) {
                        var e, i, r, a, n = t.data, s = n.length, o = n[0], h = o, l = n[1], d = l, c = n[2], g = c, u = this.enhance();
                        if (0 !== u) {
                            for(a = 0; a < s; a += 4)(e = n[a + 0]) < o ? o = e : e > h && (h = e), (i = n[a + 1]) < l ? l = i : i > d && (d = i), (r = n[a + 2]) < c ? c = r : r > g && (g = r);
                            var f, p, v, m, _, y, x, b, S;
                            for(h === o && (h = 255, o = 0), d === l && (d = 255, l = 0), g === c && (g = 255, c = 0), u > 0 ? (p = h + u * (255 - h), v = o - u * (o - 0), _ = d + u * (255 - d), y = l - u * (l - 0), b = g + u * (255 - g), S = c - u * (c - 0)) : (p = h + u * (h - (f = 0.5 * (h + o))), v = o + u * (o - f), _ = d + u * (d - (m = 0.5 * (d + l))), y = l + u * (l - m), b = g + u * (g - (x = 0.5 * (g + c))), S = c + u * (c - x)), a = 0; a < s; a += 4)n[a + 0] = ti(n[a + 0], o, h, v, p), n[a + 1] = ti(n[a + 1], l, d, y, _), n[a + 2] = ti(n[a + 2], c, g, S, b);
                        }
                    },
                    ...
                    Kaleidoscope: function(t) {
                        var e, i, r, a, n, s, o, h, l, d = t.width, c = t.height, u = Math.round(this.kaleidoscopePower()), f = Math.round(this.kaleidoscopeAngle()), p = Math.floor(d * (f % 360) / 360);
                        if (!(u < 1)) {
                            var v = g.createCanvasElement();
                            v.width = d, v.height = c;
                            var m = v.getContext("2d").getImageData(0, 0, d, c);
                            !function(t, e, i) {
                                var r, a, n, s, o = t.data, h = e.data, l = t.width, d = t.height, c = i.polarCenterX || l / 2, g = i.polarCenterY || d / 2, u = 0, f = 0, p = 0, v = 0, m = Math.sqrt(c * c + g * g);
                                a = l - c, n = d - g, m = (s = Math.sqrt(a * a + n * n)) > m ? s : m;
                                var _, y, x, b, S = d, w = l, C = 360 / w * Math.PI / 180;
                                for(y = 0; y < w; y += 1)for(x = Math.sin(y * C), b = Math.cos(y * C), _ = 0; _ < S; _ += 1)a = Math.floor(c + m * _ / S * b), u = o[0 + (r = 4 * ((n = Math.floor(g + m * _ / S * x)) * l + a))], f = o[r + 1], p = o[r + 2], v = o[r + 3], h[0 + (r = 4 * (y + _ * l))] = u, h[r + 1] = f, h[r + 2] = p, h[r + 3] = v;
                            }(t, m, {
                                polarCenterX: d / 2,
                                polarCenterY: c / 2
                            });
                            ...
                            for(p + _ > d && (x = y, b = 0, S = -1), i = 0; i < c; i += 1)for(e = x; e !== b; e += S)h = 4 * (d * i + Math.round(e + p) % d), a = m.data[h + 0], n = m.data[h + 1], s = m.data[h + 2], o = m.data[h + 3], l = 4 * (d * i + e), m.data[l + 0] = a, m.data[l + 1] = n, m.data[l + 2] = s, m.data[l + 3] = o;
                            for(i = 0; i < c; i += 1)for(y = Math.floor(_), r = 0; r < u; r += 1){
                            ...
                            !function(t, e, i) {
                                var r, a, n, s, o, h, l = t.data, d = e.data, c = t.width, g = t.height, u = i.polarCenterX || c / 2, f = i.polarCenterY || g / 2, p = 0, v = 0, m = 0, _ = 0, y = Math.sqrt(u * u + f * f);
                                a = c - u, n = g - f, y = (h = Math.sqrt(a * a + n * n)) > y ? h : y;
                                var x, b, S, w = g, C = c, P = i.polarRotation || 0;
                                for(a = 0; a < c; a += 1)for(n = 0; n < g; n += 1)s = a - u, o = n - f, x = Math.sqrt(s * s + o * o) * w / y, b = (b = (180 * Math.atan2(o, s) / Math.PI + 360 + P) % 360) * C / 360, S = Math.floor(b), p = l[0 + (r = 4 * (Math.floor(x) * c + S))], v = l[r + 1], m = l[r + 2], _ = l[r + 3], d[0 + (r = 4 * (n * c + a))] = p, d[r + 1] = v, d[r + 2] = m, d[r + 3] = _;
                            }(m, t, {
                                polarRotation: 0
                            });
                        }
                    ...
                    Mask: function(t) {
                        var e = function(t, e) {
                            var i = ei(t, 0, 0), r = ei(t, t.width - 1, 0), a = ei(t, 0, t.height - 1), n = ei(t, t.width - 1, t.height - 1), s = e || 10;
                            if (ii(i, r) < s && ii(r, n) < s && ii(n, a) < s && ii(a, i) < s) {
                                for(var o = function(t) {
                                    for(var e = [
                                        ...
                                        0,
                                        0
                                    ], i = 0; i < t.length; i++)e[0] += t[i][0], e[1] += t[i][1], e[2] += t[i][2];
                    ...
                    Pixelate: function(t) {
                        var e, i, r, a, n, s, o, h, l, d, c, u, f, p, v = Math.ceil(this.pixelSize()), m = t.width, _ = t.height, y = Math.ceil(m / v), x = Math.ceil(_ / v), b = t.data;
                        if (v <= 0) g.error("pixelSize value can not be <= 0");
                        else for(u = 0; u < y; u += 1)for(f = 0; f < x; f += 1){
                            for(a = 0, n = 0, s = 0, o = 0, l = (h = u * v) + v, c = (d = f * v) + v, p = 0, e = h; e < l; e += 1)if (!(e >= m)) for(i = d; i < c; i += 1)i >= _ || (a += b[(r = 4 * (m * i + e)) + 0], n += b[r + 1], s += b[r + 2], o += b[r + 3], p += 1);
                    ...
                    Sepia: function(t) {
                        ...
                        for(e = 0; e < s; e += 4)i = n[e + 0], r = n[e + 1], a = n[e + 2], n[e + 0] = Math.min(255, 0.393 * i + 0.769 * r + 0.189 * a), n[e + 1] = Math.min(255, 0.349 * i + 0.686 * r + 0.168 * a), n[e + 2] = Math.min(255, 0.272 * i + 0.534 * r + 0.131 * a);
                    },
                    Solarize: function(t) {
    ...
    function colorHextoRGBA(sHex, alpha = 1) {
        ...
        /* 16进制颜色转为RGB格式 */ let sColor = sHex.toLowerCase();
    ...
    function arrayConvert(arr) {
        let points = [];
        for (let item of arr)points.push(item[0], item[1]);
        return points;
    }
    /**
	 * @description 拖拽点吸附
	 ...
	 */ function adsorb(target, layer) {
        ...
        for (let item of targetAnchor){
            ...
            item.on('dragend', function(e) {
                ...
                for (let ar of layerAnchor){
                    if (ar == this) continue;
                    if (haveIntersection(ar.getClientRect(), tarRect)) {
                        if (this.getParent() == ar.getParent()) {
        ...
        function haveIntersection(r1, r2, scope = 2) {
            return !(r2.x > r1.x + r1.width / scope || r2.x + r2.width / scope < r1.x || r2.y > r1.y + r1.height / scope || r2.y + r2.height / scope < r1.y);
        }
    }
	 ...
	 * Licensed under the MIT license */ (function(window, document, exportName, undefined$1) {
            var VENDOR_PREFIXES = [
                '',
                'webkit',
                'Moz',
	   ...
	   */ var extend = deprecate(function extend(dest, src, merge) {
                ...
                var i = 0;
                while(i < keys.length){
                    if (!merge || merge && dest[keys[i]] === undefined$1) dest[keys[i]] = src[keys[i]];
                    i++;
                }
                return dest;
            }, 'extend', 'Use `assign`.');
	   ...
	   */ function triggerDomEvent(event, data) {
            ...
            if (typeof undefined$1 === 'function' && undefined$1.amd) undefined$1(function() {
                return Hammer;
            });
	 ...
	 */ class Stage extends konva_min.Stage {
        constructor(attrs){
            ...
            !attrs.scaleMax && (attrs.scaleMax = 10); //最大缩放
            !attrs.scaleMin && (attrs.scaleMin = 0.1); //最小缩放
            super(attrs);
	 ...
	 */ function dragBoundFunc(pos) {
        ...
        //单独x轴拖拽限制
        if (img.width * scale.x > size.width) {
            if (apos.x > x) {
        ...
        this.on(' pinchstart pinchmove pinchend wheel', (e)=>{
            ...
            switch(e.type){
                case 'wheel':
                    ...
                    if (newScale >= scaleRange.max || newScale <= scaleRange.min) return;
                    newPos = {
	...
	***************************************************************************** */ function __awaiter(thisArg, _arguments, P, generator) {
	 ...
	 */ class Group extends konva_min.Group {
        constructor(attrs){
            attrs["awaitMap"] !== false && (attrs["awaitMap"] = true);
            super(attrs);
            if (attrs["awaitMap"]) {
	 ...
	 */ class BaseMap extends konva_min.Group {
        constructor(attrs = {
            ...
            attrs["awaitMap"] !== false && (attrs["awaitMap"] = true);
            super(attrs);
            this._image = new konva_min.Image({
                id: "_image"
            });
            this._state = false;
	     ...
	     * return BaseMap对象
	     */ image(img) {
            let width = img.width, height = img.height; //图片高度
            ...
            this._state = true;
            if (this.attrs["awaitMap"]) this._wacth.time = new Date().getTime();
            return this;
        }
        /**
	 ...
	 */ class Grid extends konva_min.Group {
	     ...
	     */ drawGraph() {
            ...
            //未获取到舞台节点，抛出异常
            if (_stage == null) throw new Error("The stage node was not obtained");
            ...
            for(let xc = 1; xc <= YGCount; xc++){
                let levelLine = new konva_min.Line({
                    name: 'levelLine',
                    points: [
                        0 - stagePos.x - 0.5,
                        0 - stagePos.y + size * xc - 0.5,
                        startPoint.x - 0.5,
                        0 - stagePos.y + size * xc - 0.5
                    ],
                    stroke: color,
	 ...
	 */ class Location extends konva_min.Group {
        ...
        drawGraph() {
            ...
            this._drag_group = new konva_min.Group({
                id: "_drag_group",
                visible: false
            }); //拖拽图形组
            //主题颜色 rgb反色
            ...
            this._scope = new konva_min.Circle({
                ...
                fillRadialGradientColorStops: [
                    0,
                    `rgba(${themeColorArray.join(',')}, 0.4)`,
                    0.3,
                    `rgba(${themeColorArray.join(',')}, 0.2)`,
                    1,
                    'rgba(255, 255, 255,0)'
                ],
            ...
            this.location({
                ...
                angle: typeof attrs.angle == 'number' ? attrs.angle : 0
            });
        }
        /**
	     ...
	     */ draggable(param) {
            ...
            if (param) this.on("dragstart.—custom dragmove.—custom dragend.—custom touchstart.—custom touchmove.—custom touchend.—custom", function(e) {
                e.cancelBubble = true; //阻止事件冒泡
            });
            else this.off("dragstart.—custom dragmove.—custom dragend.—custom touchstart.—custom touchmove.—custom touchend.—custom");
	     ...
	     */ location(param) {
            ...
            this._drag_group_anchor.absolutePosition({
                x,
                y
            });
            let arPos = this._drag_group_anchor.position();
            this._drag_group_line.points([
                0,
                0,
                arPos.x,
                arPos.y
    ...
    function anchor(attrs) {
        ...
        let arrow = new konva_min.RegularPolygon({
            ...
            rotation: 90,
            fill: attrs.themeColor || 'rgb(255, 0, 0)'
        });
	 ...
	 */ class Track extends konva_min.Line {
        ...
        //当前画笔位置
        lineTo(pos) {
            var newPoints = this.points().concat([
                pos.x,
                pos.y
            ]);
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2022-04-18 14:50:03
	 ...
	 */ class AnchorLine extends konva_min.Group {
        constructor(attrs){
            attrs["absoluteSize"] === false || (attrs["absoluteSize"] = true); //绝对尺寸，与舞台一同缩放
            attrs["anchor"] === false || (attrs["anchor"] = true); //拖拽锚点
            super(attrs);
            this._strokeWidth = attrs.strokeWidth || 1; //宽度默认为1
            this._hitStrokeWidth = attrs.hitStrokeWidth;
            if (attrs.draggable) this.on("dragstart.—custom dragmove.—custom dragend.—custom touchstart.—custom touchmove.—custom touchend.—custom", function(e) {
                e.cancelBubble = true; //阻止事件冒泡
            });
            this._stage = window["_KMap"]["_Stage"]; //(window as any)._KMap_Stage
            this._lineFun(attrs);
            if (attrs['anchor'] !== false) attrs.points.forEach((_item, _index, _array)=>{
                this._circleFun({
                    x: _item[0],
                    y: _item[1]
                }, _index);
            ...
            //锚点拖拽吸附
            if (this.attrs.adsorb) adsorb(this, this._stage);
            let self = this;
            ...
            this._stage.addEventListener("scaleend setscale", function(e) {
                ...
                if (self.attrs.absoluteSize) {
                    ...
                    if (!self.attrs.closed) // self._line.strokeWidth(self._strokeWidth / scale) //缩放线宽度
                    self._line.hitStrokeWidth(self._hitStrokeWidth / scale); //缩放点击识别范围
                }
                //获取拖拽锚点
                let anchorArr = self.find("._drag_anchor");
                for (let item of anchorArr)item.scale({
                    x: 1 / scale,
                    y: 1 / scale
                });
            });
        ...
        _circleFun({ x , y  }, index) {
            ...
            this.add(_anchor);
            if (index) this.findOne(`#_drag_anchor-${index - 1}`).stroke("#00aaff");
	     ...
	     */ addPoints(points) {
            ...
            if (this.attrs.anchor) {
                ...
                if (this.attrs.adsorb) adsorb(this, this._stage); //锚点拖拽吸附
            }
	     ...
	     */ getAnchor(selector) {
            if (selector) return this.findOne(selector);
	     ...
	     */ adsorb(param) {
            ...
            if (param && this.attrs.adsorb !== true) {
                ...
                //移除 拖拽结束事件 关闭吸附功能
                for (let item of this.find("._drag_anchor"))item.off('dragend');
                this.attrs.adsorb = param;
            }
            return param;
        }
	 ...
	 */ class Circle extends konva_min.Circle {
        constructor(attrs){
            let _stage = window["_KMap"]["_Stage"]; //(window as any)._KMap_Stage
            attrs["absoluteSize"] === false || (attrs["absoluteSize"] = true); //绝对尺寸，不与舞台一同缩放
            // let config = JSON.parse(JSON.stringify(attrs))
            super(attrs);
            let self = this;
            scale_event();
	 ...
	 */ class Text extends konva_min.Text {
        constructor(attrs){
            ...
            _stage.addEventListener("scaleend setscale", function(e) {
                e.cancelBubble = true;
                if (attrs.absoluteSize) scale_event();
            });
            scale_event();
            function scale_event() {
                return __awaiter(this, void 0, void 0, function*() {
	 ...
	 * @exports Konva.Group
	 * @param {Object} attrs
	 */ class Magnifying extends konva_min.Group {
        constructor(attrs){
            super({
                id: "Magnifying"
            });
            ...
            this.attrs = attrs;
            __classPrivateFieldSet(this, _Magnifying_viewBox, new konva_min.Circle({
                radius: attrs.radius,
                fill: attrs.radius,
                stroke: attrs.stroke,
                strokeWidth: 2
	 ...
	 * @LastEditors: wjz
	 * @LastEditTime: 2022-04-18 15:41:18
...
//# sourceMappingURL=index.bc63f7cf.js.map
