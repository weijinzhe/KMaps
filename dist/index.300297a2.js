(function(global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory() : typeof define === 'function' && define.amd ? define(factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.KMap = factory());
})(this, function() {
    'use strict';
    ...
    function scaleConversio(params) {
    }
    ...
    var konva_min = createCommonjsModule(function(module, exports) {
        !function(t, e) {
            ...
            class P {
                ...
                _enableTrace() {
                    var t, e, i = this, r = k.length, a = this.setAttr, n = function(t) {
                        var r, a = i[t];
                        i[t] = function() {
            ...
            class K {
                ...
                _toKonvaCanvas(t) {
                    ...
                    var e = this.getClientRect(), i = this.getStage(), r = void 0 !== t.x ? t.x : e.x, a = void 0 !== t.y ? t.y : e.y, n = t.pixelRatio || 1, s = new R({
            ...
            var nt = "mouseleave", st = "mouseover", ot = "mouseenter", ht = "mousemove", lt = "mousedown", dt = "mouseup", ct = "pointermove", gt = "pointerdown", ut = "pointerup", ft = "pointercancel", pt = "pointerout", vt = "pointerleave", mt = "pointerover", _t = "pointerenter", yt = "contextmenu", xt = "touchstart", bt = "touchend", St = "touchmove", wt = "touchcancel", Ct = "wheel", kt = [
                [
                    ot,
                    "_pointerenter"
                ],
            ...
            , At = (t)=>{
                const e = Tt(t);
                return "pointer" === e ? i1.pointerEventsEnabled && Pt.pointer : "touch" === e ? Pt.touch : "mouse" === e ? Pt.mouse : void 0;
            };
            function Mt(t = {
            }) {
            ...
            class Rt extends J {
                ...
                _pointerup(t) {
                    ...
                    this._changedPointerPositions.forEach((h)=>{
                        ...
                        let g = !1;
                        i1["_" + r + "InDblClickWindow"] && i1["_" + r + "InDblClickWindowId"] === d ? (g = !0, clearTimeout(this[r + "DblTimeout"])) : L.justDragged || (i1["_" + r + "InDblClickWindow"] = !0, i1["_" + r + "InDblClickWindowId"] = d, clearTimeout(this[r + "DblTimeout"])), this[r + "DblTimeout"] = setTimeout(function() {
            ...
            Rt.prototype.nodeType = "Stage", r1(Rt), w.addGetterSetter(Rt, "container");
            var Et = "hasShadow", Lt = "shadowRGBA", Dt = "patternImage", Ot = "linearGradient", It = "radialGradient";
            let Ft;
            function Nt() {
            ...
            class zt extends K {
                ...
                hasShadow() {
                    return this._getCache(Et, this._hasShadow);
                }
                _hasShadow() {
            ...
            class Yt extends J {
                constructor(t){
                    super(t), this.canvas = new R, this.hitCanvas = new E({
                        pixelRatio: 1
                ...
                static parsePathData(t) {
                    ...
                    for(r = 1; r < n.length; r++){
                        ...
                        for(; u.length > 0 && !isNaN(u[0]);){
                            var m, _, y, x, b, S, w, C, k, P, T = null, A = [], M = h, G = l;
                            switch(g){
                                case "l":
            ...
            var ke, Pe = "auto", Te = "justify", Ae = "left", Me = "middle", Ge = "normal", Re = " ", Ee = [
                "fontFamily",
                "fontSize",
                "fontStyle",
                "fontVariant",
            ...
            class Oe extends zt {
                constructor(t){
                    ...
                    for(var e = 0; e < Le; e++)this.on(Ee[e] + "Change.konva", this._setTextData);
                    this._setTextData();
                }
                _sceneFunc(t) {
                    ...
                    if (this.text()) {
                        ...
                        for(t.setAttr("font", this._getContextFont()), t.setAttr("textBaseline", Me), t.setAttr("textAlign", Ae), o === Me ? h = (this.getHeight() - i * s - 2 * a) / 2 : "bottom" === o && (h = this.getHeight() - i * s - 2 * a), t.translate(a, h + a), r = 0; r < i; r++){
                            m = 0, _ = 0;
                            var y, x, b, S = e[r], w = S.text, C = S.width, k = r !== i - 1;
                            if (t.save(), "right" === l ? m += d - C - 2 * a : "center" === l && (m += (d - C - 2 * a) / 2), f && (t.save(), t.beginPath(), t.moveTo(m, v + _ + Math.round(n / 2)), x = 0 === (y = w.split(" ").length - 1), b = l === Te && k && !x ? d - 2 * a : C, t.lineTo(m + Math.round(b), v + _ + Math.round(n / 2)), t.lineWidth = n / 15, t.strokeStyle = g, t.stroke(), t.restore()), p && (t.save(), t.beginPath(), t.moveTo(m, v + _), x = 0 === (y = w.split(" ").length - 1), b = l === Te && k && !x ? d - 2 * a : C, t.lineTo(m + Math.round(b), v + _), t.lineWidth = n / 15, t.strokeStyle = g, t.stroke(), t.restore()), 0 !== c || l === Te) {
                                y = w.split(" ").length - 1;
                                for(var P = Ce(w), T = 0; T < P.length; T++){
                                    var A = P[T];
                                    " " === A && r !== i - 1 && l === Te && (m += (d - 2 * a - C) / y), this._partialTextX = m, this._partialTextY = v + _, this._partialText = A, t.fillStrokeShape(this), m += this.measureSize(A).width + c;
                                }
                ...
                getHeight() {
                    return this.attrs.height === Pe || void 0 === this.attrs.height ? this.fontSize() * this.textArr.length * this.lineHeight() + 2 * this.padding() : this.attrs.height;
                }
                getTextWidth() {
                ...
                _getContextFont() {
                    return this.fontStyle() + Re + this.fontVariant() + Re + (this.fontSize() + "px ") + this.fontFamily().split(",").map((t)=>{
                ...
                _setTextData() {
                    var t = this.text().split("\n"), e = +this.fontSize(), i = 0, r = this.lineHeight() * e, a = this.attrs.width, n = this.attrs.height, s = a !== Pe && void 0 !== a, o = n !== Pe && void 0 !== n, h = this.padding(), l = a - 2 * h, d = n - 2 * h, c = 0, g = this.wrap(), u = "none" !== g, f = "char" !== g && u, p = this.ellipsis();
                    ...
                    for(var v = p ? this._getTextWidth("…") : 0, m = 0, _ = t.length; m < _; ++m){
                        ...
                        if (s && x > l) for(; y.length > 0;){
                            for(var b = 0, S = y.length, w = "", C = 0; b < S;){
                                var k = b + S >>> 1, P = y.slice(0, k + 1), T = this._getTextWidth(P) + v;
                                T <= l ? (b = k + 1, w = P, C = T) : S = k;
                            }
                            if (!w) break;
                            if (f) {
                                var A, M = y[w.length];
                                (A = (M === Re || "-" === M) && C <= l ? w.length : Math.max(w.lastIndexOf(Re), w.lastIndexOf("-")) + 1) > 0 && (b = A, w = w.slice(0, b), C = this._getTextWidth(w));
                            }
            ...
            class Ke extends jt {
                ...
                setNodes(t = []) {
                    return this._nodes && this._nodes.length && this.detach(), this._nodes = t, 1 === t.length && this.useSingleNodeRotation() ? this.rotation(t[0].getAbsoluteRotation()) : this.rotation(0), this._nodes.forEach((t)=>{
                        const e = t._attrsAffectingSize.map((t)=>t + "Change." + ze
                        ).join(" "), i = ()=>{
                        ...
                        t.on(e, i), t.on(Ye, i), t.on("absoluteTransformChange.tr-konva", i), t.on("xChange.tr-konva yChange.tr-konva", i), this._proxyDrag(t);
                    ...
                    if (l.x !== d.x || l.y !== d.y) {
                        if ("rotater" !== this._movingAnchorName) {
                            ...
                            const s = i1.getAngle(this.rotation()) + a, o = i1.getAngle(this.rotationSnapTolerance()), h = function(t, e, r) {
                                ...
                                return a;
                            }(this.rotationSnaps(), s, o), l = Ve(P, h - P.rotation);
            ...
            return te.Util._assign(te, {
                ...
                Filters: {
                    Blur: function(t) {
                        ...
                        e > 0 && (function(t, e) {
                            var i, r, a, n, s, o, h, l, d, c, g, u, f, p, v, m, _, y, x, b, S, w, C, k, P = t.data, T = t.width, A = t.height, M = e + e + 1, G = T - 1, R = A - 1, E = e + 1, L = E * (E + 1) / 2, D = new Je, O = null, I = D, F = null, N = null, B = Ze[e], z = $e[e];
                            for(a = 1; a < M; a++)I = I.next = new Je, a === E && (O = I);
                            for(I.next = D, h = o = 0, r = 0; r < A; r++){
                                for(m = _ = y = x = l = d = c = g = 0, u = E * (b = P[o]), f = E * (S = P[o + 1]), p = E * (w = P[o + 2]), v = E * (C = P[o + 3]), l += L * b, d += L * S, c += L * w, g += L * C, I = D, a = 0; a < E; a++)I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                                for(a = 1; a < E; a++)n = o + ((G < a ? G : a) << 2), l += (I.r = b = P[n]) * (k = E - a), d += (I.g = S = P[n + 1]) * k, c += (I.b = w = P[n + 2]) * k, g += (I.a = C = P[n + 3]) * k, m += b, _ += S, y += w, x += C, I = I.next;
                            ...
                            for(i = 0; i < T; i++){
                                for(_ = y = x = m = d = c = g = l = 0, u = E * (b = P[o = i << 2]), f = E * (S = P[o + 1]), p = E * (w = P[o + 2]), v = E * (C = P[o + 3]), l += L * b, d += L * S, c += L * w, g += L * C, I = D, a = 0; a < E; a++)I.r = b, I.g = S, I.b = w, I.a = C, I = I.next;
                                for(s = T, a = 1; a <= e; a++)o = s + i << 2, l += (I.r = b = P[o]) * (k = E - a), d += (I.g = S = P[o + 1]) * k, c += (I.b = w = P[o + 2]) * k, g += (I.a = C = P[o + 3]) * k, m += b, _ += S, y += w, x += C, I = I.next, a < R && (s += T);
                                for(o = i, F = D, N = O, r = 0; r < A; r++)P[3 + (n = o << 2)] = C = g * B >> z, C > 0 ? (C = 255 / C, P[n] = (l * B >> z) * C, P[n + 1] = (d * B >> z) * C, P[n + 2] = (c * B >> z) * C) : P[n] = P[n + 1] = P[n + 2] = 0, l -= u, d -= f, c -= p, g -= v, u -= F.r, f -= F.g, p -= F.b, v -= F.a, n = i + ((n = r + E) < R ? n : R) * T << 2, l += m += F.r = P[n], d += _ += F.g = P[n + 1], c += y += F.b = P[n + 2], g += x += F.a = P[n + 3], F = F.next, u += b = N.r, f += S = N.g, p += w = N.b, v += C = N.a, m -= b, _ -= S, y -= w, x -= C, N = N.next, o += T;
                            }
                        })(t, e);
                    },
                    Brighten: function(t) {
                        ...
                        do {
                            ...
                            do {
                                ...
                                if ((b > 0 ? b : -b) > C && (w = b), (S > 0 ? S : -S) > C && (w = S), w *= e, a) {
                                    var k = o[m] + w, P = o[m + 1] + w, T = o[m + 2] + w;
                    ...
                    Kaleidoscope: function(t) {
                        ...
                        if (!(u < 1)) {
                            ...
                            !function(t, e, i) {
                                ...
                                for(a = 0; a < c; a += 1)for(n = 0; n < g; n += 1)s = a - u, o = n - f, x = Math.sqrt(s * s + o * o) * w / y, b = (b = (180 * Math.atan2(o, s) / Math.PI + 360 + k) % 360) * C / 360, S = Math.floor(b), p = l[0 + (r = 4 * (Math.floor(x) * c + S))], v = l[r + 1], m = l[r + 2], _ = l[r + 3], d[0 + (r = 4 * (n * c + a))] = p, d[r + 1] = v, d[r + 2] = m, d[r + 3] = _;
                            }(m, t, {
                                polarRotation: 0
                            });
                        }
	...
	***************************************************************************** */ function __awaiter(thisArg, _arguments, P, generator) {
	 ...
	 */ class Location extends konva_min.Group {
        constructor(attrs = {
            ...
            attrs["awaitMap"] = true;
            super(attrs);
            this._group = new konva_min.Group("_Location"); //坐标系基准，以此图组作为相对位置
        ...
        drawGraph() {
            ...
            wheelEvent(this._stage, (e)=>{
                if (e.type == "wheelend") scale_event();
            });
        }
        /**
	 ...
	 */ class Track extends konva_min.Group {
        constructor(attrs = {
            pixelRatio: 2,
            strokeWidth: 5
        }){
        ...
        _image() {
            ...
            this._image = new konva_min.Image({
                ...
                y: 0,
                scale: {
                    x: 1 / attrs.pixelRatio,
                    y: 1 / attrs.pixelRatio
                },
                stroke: "#f50015",
                strokeWidth: 5
            });
	 ...
	 */ /**
	 * @description
	 */ class ShapeNode extends konva_min.Group {
        constructor(attrs){
            super(attrs);
        ...
        _circleFun({ x , y  }, index) {
            ...
            this.add(_anchor);
            _anchor.on("dragmove", function(e) {
                e.cancelBubble = true;
                let points = []; //拖拽锚点当前坐标
	     ...
	     */ draggable(param) {
            ...
            for (let item of anchorArr)item.visible(param);
	 ...
	 * @Date: 2021-11-18 10:08:49
	 * @LastEditors: wjz
	 * @LastEditTime: 2021-11-22 09:34:20
	 ...
	 */ class Line extends ShapeNode {
        constructor(attrs){
            super(Object.assign(Object.assign({
                ...
                name: "Line",
                strokeWidth: attrs.strokeWidth || 3,
                hitStrokeWidth: 20
            }));
            let self = this;
            this._stage = window["_KMap"]["_Stage"]; //(window as any)._KMap_Stage
	 ...
	 */ class Polygon extends ShapeNode {
        constructor(attrs){
            super(Object.assign(Object.assign({
            }, attrs), {
                name: "Polygon",
...
//# sourceMappingURL=index.300297a2.js.map
